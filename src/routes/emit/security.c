 ...
 * @brief Autogenerated docstring
 */
int ref_base_matches_self_uri(const char *self_uri, const char *ref,
                                     size_t base_len) {
 ...
 * @brief Autogenerated docstring
 */
int scheme_ref_matches_name(const char *req_scheme,
 ...
 * @brief Autogenerated docstring
 */
int scheme_is_active(const struct OpenAPI_SecurityScheme *sch,
