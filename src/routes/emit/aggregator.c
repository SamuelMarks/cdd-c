 ...
 */
int find_path_in_list(struct OpenAPI_Path *paths, size_t n_paths,
                             const char *route,
 ...
 * @brief Autogenerated docstring
 */
int append_path_to_list(struct OpenAPI_Path **paths, size_t *n_paths,
                               const char *route,
 ...
 * @brief Autogenerated docstring
 */
int append_operation(struct OpenAPI_Operation **ops, size_t *count,
