...
extern C_CDD_EXPORT enum cdd_c_error parse_example_any(const char *example,
                                                       struct OpenAPI_Any *out);
extern C_CDD_EXPORT enum cdd_c_error
is_reserved_header_name(const char *name, int *out_is_reserved);
extern C_CDD_EXPORT enum cdd_c_error
...
response_has_media_type(const struct OpenAPI_Response *resp, const char *name,
                        int *out_has);
extern C_CDD_EXPORT enum cdd_c_error
is_struct_pointer(const char *type, int *is_double_ptr, int *out_is_struct_ptr);
extern C_CDD_EXPORT enum cdd_c_error
