  ...
  if (config && !config->no_installable_package) {
    ...
    if (uh) {
      ...
      fputs(
          ...
          uh);
      fputs(
          "extern  cdd_c_error_t url_encode(const char *str, char "
          "**_out_val);\n"
          "\n"
          "/**\n"
          " * @param[out] _out_val Pointer to store the result\n"
      ...
      fputs(
          ...
          uh);
      fputs(
          "extern  cdd_c_error_t url_query_add_encoded(struct "
          "UrlQueryParams *qp,\n"
          "                                              const char *key,\n"
          "                                              const char *value);\n"
          "\n"
    ...
    if (uc) {
      ...
      fputs("  case '!':\n"
            ...
            "static int\n",
            uc);
      fputs("    is_pct_encoded(const char *p) {\n"
            "  if (!p)\n"
            "    return CDD_C_SUCCESS;\n"
      ...
      fputs("    *_out_val = hex[code & 15];\n"
            ...
            " */\n",
            uc);
      fputs("cdd_c_error_t url_encode(const char *str, char **_out_val) {\n"
            "  char _ast_to_hex_0;\n"
            "  char _ast_to_hex_1;\n"
            "  const char *p;\n"
            "  char *enc = NULL;\n"
            ...
            "  for (p = str; *p; p++) {\n",
            uc);
      fputs("    if (is_unreserved((unsigned char)*p)) {\n"
            "      needed_len++;\n"
            "    } else {\n"
            "      needed_len += 3; /* %HH */\n"
            "    }\n"
      ...
      fputs("    if (is_unreserved(c)) {\n"
            ...
            "/**\n",
            uc);
      fputs(" * @brief Executes the url encode allow reserved operation.\n"
            " */\n"
            "cdd_c_error_t url_encode_allow_reserved(const char *str, char "
            "**_out_val) {\n"
            "  char _ast_to_hex_2;\n"
            "  char _ast_to_hex_3;\n"
            "  const char *p;\n"
            ...
            "\n",
            uc);
      fputs("  /* Pass 1: Calculate required length */\n"
            "  for (p = str; *p; p++) {\n"
      ...
      fputs("      *e++ = *p;\n"
            ...
            " */\n",
            uc);
      fputs("cdd_c_error_t url_encode_form(const char *str, char **_out_val) "
            "{\n"
            "  char _ast_to_hex_4;\n"
            "  char _ast_to_hex_5;\n"
            "  const char *p;\n"
      ...
      fputs("      *e++ = '+';\n"
            ...
            "/**\n",
            uc);
      fputs(" * @brief Executes the url encode form allow reserved operation.\n"
            " */\n"
            "cdd_c_error_t url_encode_form_allow_reserved(const char *str, "
            "char "
            "**_out_val) {\n"
            "  char _ast_to_hex_6;\n"
            "  char _ast_to_hex_7;\n"
      ...
      fputs("      if (qp->params[i].key)\n"
            ...
            " */\n"
            "cdd_c_error_t url_query_add(struct UrlQueryParams *qp, const ",
            uc);
      fputs("char *key,\n"
            "                  const char *value) {\n"
            ...
            "*)realloc(\n",
            uc);
      fputs("        qp->params, new_cap * sizeof(struct UrlQueryParam));\n"
            "    if (!new_arr) {\n"
            "      C_CDD_LOG_DEBUG(\"ENOMEM: OOM\\n\");\n"
            "      return CDD_C_ERROR_MEMORY;\n"
            "    }\n"
            ...
            uc);
      fputs("    return CDD_C_ERROR_MEMORY;\n"
            "\n"
            ...
            "/**\n",
            uc);
      fputs(" * @brief Executes the url query add encoded operation.\n"
            " */\n"
            "cdd_c_error_t url_query_add_encoded(struct UrlQueryParams *qp, "
            "const char "
            "*key,\n"
            "                          const char *value) {\n"
            ...
            "  if (qp->count >= qp->capacity) {\n",
            uc);
      fputs("    size_t new_cap = (qp->capacity == 0) ? 4 : qp->capacity * 2;\n"
            "    struct UrlQueryParam *new_arr = (struct UrlQueryParam "
            "*)realloc(\n"
      ...
      fputs("  qp->params[qp->count].key =\n"
            ...
            "  }\n",
            uc);
      fputs("  qp->params[qp->count].value_is_encoded = 1;\n"
            "\n"
            "  qp->count++;\n"
            "  return CDD_C_SUCCESS;\n"
            "}\n"
            ...
            " */\n"
            "cdd_c_error_t url_query_build(const struct UrlQueryParams *qp, "
            "char "
            "**out_str) {\n"
            ...
            uc);
      fputs("  char *_ast_url_encode_13 = NULL;\n"
      ...
      fputs(
          ...
          "    } else {\n",
          uc);
      fputs("      e_val = (url_encode(raw_val, &_ast_url_encode_11), "
            "_ast_url_encode_11);\n"
            "    }\n"
            "\n"
            "    if (!e_key || !e_val) {\n"
      ...
      fputs(
          ...
          "    } else {\n",
          uc);
      fputs("      e_val = (url_encode(raw_val, &_ast_url_encode_13), "
            "_ast_url_encode_13);\n"
            "    }\n"
            "\n"
      ...
      fputs("      memcpy(ptr, e_val, vl);\n"
            ...
            " */\n",
            uc);
      fputs("cdd_c_error_t url_query_build_form(const struct UrlQueryParams "
            "*qp, char "
            "**out_str) {\n"
      ...
      fputs("                   _ast_url_encode_form_14);\n"
            ...
            "    } else {\n",
            uc);
      fputs("      e_val = (url_encode_form(qp->params[i].value, "
      ...
      fputs("      return CDD_C_SUCCESS;\n"
            ...
            "/**\n",
            uc);
      fputs(" * @brief Executes the openapi kv join form operation.\n"
            " */\n"
            "cdd_c_error_t openapi_kv_join_form(const struct OpenAPI_KV *kvs, "
            "size_t n,\n"
      ...
      fputs("      goto oom;\n"
            ...
            "      goto oom;\n",
            uc);
      fputs("    if (append_str(&buf, &len, &cap, enc_val) != 0)\n"
            "      goto oom;\n"
            "    free(enc_key);\n"
            "    free(enc_val);\n"
            "    enc_key = NULL;\n"
