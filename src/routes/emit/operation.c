 ...
 * @brief Autogenerated docstring
 */
int parse_link_params_json(const char *json,
 ...
 * @brief Autogenerated docstring
 */
int copy_any_value_local(struct OpenAPI_Any *dst,
 ...
 * @brief Autogenerated docstring
 */
int find_doc_param(const struct DocMetadata *doc, const char *name,
 ...
 * @brief Autogenerated docstring
 */
int is_path_param(const char *route, const char *name) {
  char tmpl[128];
  if (!route || !name)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int find_media_type(struct OpenAPI_MediaType *mts, size_t n,
                           const char *name,
 ...
 * @brief Autogenerated docstring
 */
int ensure_response_for_code(struct OpenAPI_Operation *op,
                                    const char *code,
                                    struct OpenAPI_Response **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int add_param_to_op(struct OpenAPI_Operation *op,
 ...
 * @brief Autogenerated docstring
 */
int init_media_type_from_response(struct OpenAPI_MediaType *mt,
                                         const char *name,
 ...
 * @brief Autogenerated docstring
 */
int add_response_media_type(struct OpenAPI_Response *resp,
 ...
 * @brief Autogenerated docstring
 */
int request_body_has_media_type(const struct OpenAPI_Operation *op,
                                       const char *name) {
  size_t i;
  if (!op || !name)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int init_media_type_from_request_body(struct OpenAPI_MediaType *mt,
                                             const char *name,
 ...
 * @brief Autogenerated docstring
 */
int add_request_body_media_type(struct OpenAPI_Operation *op,
                                       const char *name, int is_item_schema) {
  struct OpenAPI_MediaType *new_mts;
  size_t new_count;
 ...
 * @brief Autogenerated docstring
 */
int set_querystring_schema_from_type_map(
 ...
 * @brief Autogenerated docstring
 */
int oa_type_is_primitive(const char *type) {
  if (!type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int apply_format_to_schema_ref(struct OpenAPI_SchemaRef *schema,
