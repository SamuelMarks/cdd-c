 ...
 */
int openapi_kv_join_form(const struct OpenAPI_KV *kvs,
 ...
 * @brief Autogenerated docstring
 */
int url_encode_allow_reserved(const char *str,
                                                  char **_out_val);
 ...
 * @brief Autogenerated docstring
 */
int url_encode_form_allow_reserved(const char *str,
                                                       char **_out_val);
 ...
 * @brief Autogenerated docstring
 */
int url_query_add(struct UrlQueryParams *qp,
 ...
 * @brief Autogenerated docstring
 */
int url_query_build(const struct UrlQueryParams *qp,
                                        char **out_str);
