 ...
 */
int is_source_file(const char *path) {
 ...
 * @brief Autogenerated docstring
 */
int spec_has_tag(const struct OpenAPI_Spec *spec, const char *name) {
  size_t i;
  if (!spec || !name)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int spec_add_tag(struct OpenAPI_Spec *spec, const char *name) {
 ...
 * @brief Autogenerated docstring
 */
int spec_find_tag(struct OpenAPI_Spec *spec, const char *name,
 ...
 * @brief Autogenerated docstring
 */
int map_doc_security_type(enum DocSecurityType type,
 ...
 * @brief Autogenerated docstring
 */
int map_doc_security_in(enum DocSecurityIn in,
 ...
 * @brief Autogenerated docstring
 */
int map_doc_flow_type(enum DocOAuthFlowType type,
 ...
 * @brief Autogenerated docstring
 */
int spec_find_security_scheme(struct OpenAPI_Spec *spec,
                                     const char *name,
 ...
 * @brief Autogenerated docstring
 */
int set_str_if_missing(char **dst, const char *src) {
 ...
 * @brief Autogenerated docstring
 */
int copy_doc_server_variables(struct OpenAPI_Server *dst,
 ...
 * @brief Autogenerated docstring
 */
int merge_scopes(struct OpenAPI_OAuthFlow *dst,
 ...
 * @brief Autogenerated docstring
 */
int find_oauth_flow(struct OpenAPI_SecurityScheme *scheme,
 ...
 * @brief Autogenerated docstring
 */
int merge_oauth_flow(struct OpenAPI_OAuthFlow *dst,
                            const struct DocOAuthFlow *src) {
  int rc;
  if (!dst || !src)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int validate_doc_oauth_flow(const struct DocOAuthFlow *flow) {
  if (!flow)
    return EINVAL;
 ...
 * @brief Autogenerated docstring
 */
int add_oauth_flows(struct OpenAPI_SecurityScheme *scheme,
 ...
 * @brief Autogenerated docstring
 */
int spec_add_security_scheme(struct OpenAPI_Spec *spec,
                                    const struct DocSecurityScheme *doc) {
 ...
 * @brief Autogenerated docstring
 */
int apply_doc_security_schemes(struct OpenAPI_Spec *spec,
 ...
 * @brief Autogenerated docstring
 */
int append_root_security(struct OpenAPI_Spec *spec,
                                const struct DocMetadata *meta) {
 ...
 * @brief Autogenerated docstring
 */
int append_root_servers(struct OpenAPI_Spec *spec,
                               const struct DocMetadata *meta) {
 ...
 * @brief Autogenerated docstring
 */
int apply_doc_global_meta(struct OpenAPI_Spec *spec,
                                 const struct DocMetadata *meta) {
 ...
 * @brief Autogenerated docstring
 */
int spec_apply_tag_meta(struct OpenAPI_Spec *spec,
 ...
 * @brief Autogenerated docstring
 */
int apply_doc_tag_meta(struct OpenAPI_Spec *spec,
                              const struct DocMetadata *meta) {
  size_t i;
  int rc = 0;
 ...
 * @brief Autogenerated docstring
 */
int collect_tags_from_op(struct OpenAPI_Spec *spec,
 ...
 * @brief Autogenerated docstring
 */
int collect_tags_from_paths(struct OpenAPI_Spec *spec,
 ...
 * @brief Autogenerated docstring
 */
int collect_spec_tags(struct OpenAPI_Spec *spec) {
  int rc;
  if (!spec)
    return EINVAL;
 ...
 * @brief Autogenerated docstring
 */
int parse_c_signature_string(const char *sig_str,
 ...
 * @brief Autogenerated docstring
 */
int process_file(const char *path, struct OpenAPI_Spec *spec) {
  char *content = NULL;
  size_t sz = 0;
 ...
 * @brief Autogenerated docstring
 */
int walker_cb(const char *path, void *user_data) {
 ...
 * @brief Autogenerated docstring
 */
int load_base_spec(const char *path, struct OpenAPI_Spec *spec) {
