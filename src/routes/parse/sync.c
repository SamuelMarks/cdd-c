 ...
 */
int generate_expected_sig(const struct OpenAPI_Operation *op,
 ...
 * @brief Autogenerated docstring
 */
int generate_expected_query(const struct OpenAPI_Operation *op,
                                   char **_out_val) {
  FILE *tmp = tmpfile();
  long sz;
  char *buf;
 ...
 * @brief Autogenerated docstring
 */
int generate_expected_header_line(const struct OpenAPI_Parameter *p,
                                         char **_out_val) {
  char *buf = malloc(512);
  if (!buf) {
    *_out_val = NULL;
 ...
 * @brief Autogenerated docstring
 */
int generate_expected_url(const char *path,
 ...
 * @brief Autogenerated docstring
 */
int find_function_node(struct CstNodeList *cst, struct TokenList *tokens,
 ...
 * @brief Autogenerated docstring
 */
int extract_current_sig(struct TokenList *tokens, struct CstNode *node,
 ...
 * @brief Autogenerated docstring
 */
void apply_query_sync(const struct OpenAPI_Operation *op,
 ...
 * @brief Autogenerated docstring
 */
void apply_header_sync(const struct OpenAPI_Operation *op,
                              struct TokenList *tokens, struct CstNode *node,
                              struct PatchList *patches) {
 ...
 * @brief Autogenerated docstring
 */
int apply_updates(const char *filename,
