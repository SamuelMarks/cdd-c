 ...
 * @brief Autogenerated docstring
 */
int is_reserved(unsigned char c) {
  switch (c) {
  case ':':
  case '/':
  case '?':
 ...
 * @brief Autogenerated docstring
 */
int is_hex(unsigned char c) { return isxdigit(c) ? 1 : 0; }

static /**
 * @brief Autogenerated docstring
 */
int is_pct_encoded(const char *p) {
  if (!p)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int to_hex(char code, char *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int is_unreserved_form(unsigned char c) {
  if (isalnum(c))
    return 1;
  if (c == '-' || c == '.' || c == '_' || c == '*')
    return 1;
 ...
 * @brief Autogenerated docstring
 */
int kv_value_to_string(const struct OpenAPI_KV *kv, char *buf,
