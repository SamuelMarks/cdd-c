 ...
 * @return 0 on success.
 */
C_CDD_EXPORT enum cdd_c_error cdd_cst_alloc_node(enum cdd_cst_node_kind_t kind,
 ...
 * @return 0 on success.
 */
C_CDD_EXPORT enum cdd_c_error cdd_cst_create_token(cdd_cst_tree_t *tree,
...
cdd_cst_create_token_len(cdd_cst_tree_t *tree, enum cdd_token_kind_t kind,
 ...
 * @return 0 on success.
 */
C_CDD_EXPORT enum cdd_c_error cdd_cst_append_child_node(cdd_cst_node_t *parent,
 ...
 * @return 0 on success.
 */
C_CDD_EXPORT enum cdd_c_error cdd_cst_append_child_token(cdd_cst_node_t *parent,
                                                         cdd_token_t *token);
...
C_CDD_EXPORT enum cdd_c_error cdd_cst_parse_format(cdd_cst_tree_t *dest_tree,
                                                   cdd_cst_node_t **out_node,
                                                   const char *fmt, ...);
