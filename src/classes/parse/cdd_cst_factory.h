...
/**
 * @brief Creates a synthetic token. The text must be a static string literal or outlive the tree!
 * @param tree The CST tree.
 * @param kind The token kind.
 * @param text The literal string text.
 * @return The new token, or NULL on error.
 */
cdd_token_t *cdd_cst_create_token(cdd_cst_tree_t *tree, enum cdd_token_kind_t kind, const char *text);
 ...
 * @return The new token, or NULL on error.
 */
cdd_token_t *cdd_cst_create_token_len(cdd_cst_tree_t *tree, enum cdd_token_kind_t kind, const char *text, size_t length);
