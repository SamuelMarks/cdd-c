 ...
 */
int join_tokens_skipping_ws(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
void init_value_free(struct InitValue *val);
 ...
 * @brief Autogenerated docstring
 */
int init_list_add(struct InitList *list, char *desig,
 ...
 * @brief Autogenerated docstring
 */
int skip_ws(const struct TokenList *tokens, size_t idx, size_t limit,
                   size_t *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int is_designator_start(enum TokenKind k) {
 ...
 * @brief Autogenerated docstring
 */
int parse_designator(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int parse_expression_str(const struct TokenList *tokens, size_t start,
