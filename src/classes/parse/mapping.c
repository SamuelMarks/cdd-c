 ...
 * @brief Autogenerated docstring
 */
int set_primitive(struct OpenApiTypeMapping *out, const char *type,
                         const char *fmt) {
 ...
 * @brief Autogenerated docstring
 */
int set_ref(struct OpenApiTypeMapping *out, const char *ref) {
 ...
 * @brief Autogenerated docstring
 */
int skip_qualifiers(const char *type, const char **_out_val) {
  const char *p = type;
  while (*p) {
 ...
 * @brief Autogenerated docstring
 */
int clean_type_str(const char *in, char **_out_val) {
