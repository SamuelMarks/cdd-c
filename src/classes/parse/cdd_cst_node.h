...
enum cdd_cst_node_kind_t {
  ...
  CDD_CST_ACCESS_SPECIFIER,
  CDD_CST_CONSTRUCTOR,
  CDD_CST_DESTRUCTOR,
  CDD_CST_OPERATOR_OVERLOAD,
  CDD_CST_NAMESPACE_DECLARATION,
  CDD_CST_USING_DIRECTIVE,
  CDD_CST_TEMPLATE_DECLARATION,
  CDD_CST_TEMPLATE_PARAMETER_LIST,
  CDD_CST_TEMPLATE_PARAMETER,
  CDD_CST_BASE_CLASS_LIST,
  CDD_CST_BASE_CLASS_SPECIFIER,
  CDD_CST_TRY_BLOCK,
  CDD_CST_CATCH_BLOCK,
  CDD_CST_THROW_EXPRESSION,
  CDD_CST_NOEXCEPT_SPECIFIER,
