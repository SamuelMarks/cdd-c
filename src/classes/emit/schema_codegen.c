...
static /**
        * @brief Executes the print enum declaration operation.
        */
    int
...
static /**
        * @brief Executes the print union declaration operation.
        */
    int
...
static /**
        * @brief Executes the print struct declaration operation.
        */
    int
