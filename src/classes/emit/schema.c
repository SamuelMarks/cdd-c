 ...
 * @brief Autogenerated docstring
 */
int schema_exists(const struct OpenAPI_Spec *spec, const char *name) {
  size_t i;
 ...
 * @brief Autogenerated docstring
 */
int enum_exists(const struct OpenAPI_Spec *spec, const char *name) {
  size_t i;
  for (i = 0; i < spec->n_defined_schemas; ++i) {
    if (spec->defined_schema_names[i] &&
        strcmp(spec->defined_schema_names[i], name) == 0 &&
 ...
 * @brief Autogenerated docstring
 */
int copy_enum_members(const struct EnumMembers *src,
 ...
 * @brief Autogenerated docstring
 */
int copy_struct_fields(const struct StructFields *src,
