 ...
 */
int verb_to_str(enum OpenAPI_Verb v, char **_out_val);
static /**
 * @brief Autogenerated docstring
 */
int param_in_to_str(enum OpenAPI_ParamIn in, char **_out_val);
static /**
 * @brief Autogenerated docstring
 */
int style_to_str(enum OpenAPI_Style s, char **_out_val);
static /**
 * @brief Autogenerated docstring
 */
int oauth_flow_type_to_str(enum OpenAPI_OAuthFlowType t,
                                  char **_out_val);
static /**
 * @brief Autogenerated docstring
 */
int xml_node_type_to_str(enum OpenAPI_XmlNodeType t, char **_out_val);
static /**
 * @brief Autogenerated docstring
 */
int is_schema_primitive(const char *type);
static /**
 * @brief Autogenerated docstring
 */
int license_fields_invalid(const struct OpenAPI_License *lic);
static /**
 * @brief Autogenerated docstring
 */
int server_url_has_query_or_fragment(const char *url);
static /**
 * @brief Autogenerated docstring
 */
 ...
 * @brief Autogenerated docstring
 */
int merge_schema_extras_object(JSON_Object *target,
                                      const char *extras_json);
static /**
 * @brief Autogenerated docstring
 */
int any_to_json_value(const struct OpenAPI_Any *val,
                             JSON_Value **_out_val);
static /**
 * @brief Autogenerated docstring
 */
void write_example_object(JSON_Object *ex_obj,
                                 const struct OpenAPI_Example *ex);
static /**
 * @brief Autogenerated docstring
 */
int write_examples_object(JSON_Object *parent, const char *key,
                                 const struct OpenAPI_Example *examples,
                                 size_t n_examples);
static /**
 * @brief Autogenerated docstring
 */
void write_example_fields(JSON_Object *parent,
 ...
 * @brief Autogenerated docstring
 */
void write_schema_example(JSON_Object *obj,
                                 const struct OpenAPI_Any *example,
                                 int example_set);
static /**
 * @brief Autogenerated docstring
 */
void write_numeric_constraints(JSON_Object *obj, int has_min,
 ...
 * @brief Autogenerated docstring
 */
void write_string_constraints(JSON_Object *obj, int has_min_len,
                                     size_t min_len, int has_max_len,
                                     size_t max_len, const char *pattern);
static /**
 * @brief Autogenerated docstring
 */
void write_array_constraints(JSON_Object *obj, int has_min_items,
                                    size_t min_items, int has_max_items,
                                    size_t max_items, int unique_items);
static /**
 * @brief Autogenerated docstring
 */
void write_items_schema_fields(JSON_Object *item_obj,
                                      const struct OpenAPI_SchemaRef *ref);
static /**
 * @brief Autogenerated docstring
 */
void write_external_docs(JSON_Object *parent, const char *key,
                                const struct OpenAPI_ExternalDocs *docs);
static /**
 * @brief Autogenerated docstring
 */
void write_discriminator_object(JSON_Object *parent,
                                       const struct OpenAPI_Discriminator *disc,
                                       int disc_set);
static /**
 * @brief Autogenerated docstring
 */
void write_xml_object(JSON_Object *parent, const struct OpenAPI_Xml *xml,
                             int xml_set);
static /**
 * @brief Autogenerated docstring
 */
void write_info(JSON_Object *root_obj, const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
void write_server_object(JSON_Object *srv_obj,
                                const struct OpenAPI_Server *srv);
static /**
 * @brief Autogenerated docstring
 */
void write_schema_ref(JSON_Object *parent, const char *key,
                             const struct OpenAPI_SchemaRef *ref);
static /**
 * @brief Autogenerated docstring
 */
void write_schema_from_type_fields(JSON_Object *parent, const char *key,
                                          const char *type, int is_array,
                                          const char *items_type);
static /**
 * @brief Autogenerated docstring
 */
void write_multipart_schema(JSON_Object *parent, const char *key,
                                   const struct OpenAPI_SchemaRef *ref);
static /**
 * @brief Autogenerated docstring
 */
void write_parameter_object(JSON_Object *p_obj,
                                   const struct OpenAPI_Parameter *p);
static /**
 * @brief Autogenerated docstring
 */
void write_header_object(JSON_Object *h_obj,
                                const struct OpenAPI_Header *h);
static /**
 * @brief Autogenerated docstring
 */
void write_link_object(JSON_Object *l_obj,
                              const struct OpenAPI_Link *link);
static /**
 * @brief Autogenerated docstring
 */
int write_headers_map(JSON_Object *parent, const char *key,
                             const struct OpenAPI_Header *headers,
                             size_t n_headers, int ignore_content_type);
static /**
 * @brief Autogenerated docstring
 */
int write_headers(JSON_Object *parent,
                         const struct OpenAPI_Response *resp);
static /**
 * @brief Autogenerated docstring
 */
int write_links(JSON_Object *parent,
                       const struct OpenAPI_Response *resp);
static /**
 * @brief Autogenerated docstring
 */
int write_media_type_object(JSON_Object *media_obj,
                                   const struct OpenAPI_MediaType *mt);
static /**
 * @brief Autogenerated docstring
 */
int write_media_type_map(JSON_Object *parent, const char *key,
                                const struct OpenAPI_MediaType *mts,
                                size_t n_mts);
static /**
 * @brief Autogenerated docstring
 */
int write_encoding_object(JSON_Object *enc_obj,
                                 const struct OpenAPI_Encoding *enc);
static /**
 * @brief Autogenerated docstring
 */
int write_encoding_map(JSON_Object *media_obj,
                              const struct OpenAPI_Encoding *encoding,
                              size_t n_encoding);
static /**
 * @brief Autogenerated docstring
 */
int write_encoding_array(JSON_Object *parent, const char *key,
                                const struct OpenAPI_Encoding *encoding,
                                size_t n_encoding);
static /**
 * @brief Autogenerated docstring
 */
void write_response_object(JSON_Object *r_obj,
                                  const struct OpenAPI_Response *resp);
static /**
 * @brief Autogenerated docstring
 */
int write_operation_object(JSON_Object *op_obj,
                                  const struct OpenAPI_Operation *op);
static /**
 * @brief Autogenerated docstring
 */
int write_parameters(JSON_Object *parent,
                            const struct OpenAPI_Parameter *params,
                            size_t n_params);
static /**
 * @brief Autogenerated docstring
 */
int write_responses(JSON_Object *op_obj,
                           const struct OpenAPI_Operation *op);
static /**
 * @brief Autogenerated docstring
 */
int write_request_body(JSON_Object *op_obj,
                              const struct OpenAPI_Operation *op);
static /**
 * @brief Autogenerated docstring
 */
int write_callbacks(JSON_Object *op_obj,
                           const struct OpenAPI_Operation *op);
static /**
 * @brief Autogenerated docstring
 */
int write_operations(JSON_Object *path_item,
                            const struct OpenAPI_Path *path);
static /**
 * @brief Autogenerated docstring
 */
int write_additional_operations(JSON_Object *path_item,
                                       const struct OpenAPI_Path *path);
static /**
 * @brief Autogenerated docstring
 */
int write_path_item_object(JSON_Object *item_obj,
                                  const struct OpenAPI_Path *path);
static /**
 * @brief Autogenerated docstring
 */
int write_paths(JSON_Object *root_obj, const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_servers(JSON_Object *root_obj,
                         const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_server_array(JSON_Object *parent, const char *key,
 ...
 * @brief Autogenerated docstring
 */
int write_security_schemes(JSON_Object *components,
                                  const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_parameters(JSON_Object *components,
                                      const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_responses(JSON_Object *components,
                                     const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_headers(JSON_Object *components,
                                   const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_media_types(JSON_Object *components,
                                       const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_examples(JSON_Object *components,
                                    const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_links(JSON_Object *components,
                                 const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_callbacks(JSON_Object *components,
                                     const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_component_path_items(JSON_Object *components,
                                      const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_components(JSON_Object *root_obj,
                            const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_tags(JSON_Object *root_obj, const struct OpenAPI_Spec *spec);
static /**
 * @brief Autogenerated docstring
 */
int write_webhooks(JSON_Object *root_obj,
                          const struct OpenAPI_Spec *spec);
 ...
 * @brief Autogenerated docstring
 */
int param_is_reserved_header(const struct OpenAPI_Parameter *p) {
 ...
 * @brief Autogenerated docstring
 */
int schema_ref_has_data(const struct OpenAPI_SchemaRef *ref) {
  if (!ref)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
void write_schema_type(JSON_Object *obj, const char *type,
                              int nullable) {
  if (!obj || !type)
    return;
 ...
 * @brief Autogenerated docstring
 */
int type_union_contains(char **types, size_t n_types,
                               const char *value) {
  size_t i;
  if (!types || !value)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
void write_schema_type_union(JSON_Object *obj, const char *type,
 ...
 * @brief Autogenerated docstring
 */
void write_any_array_values(JSON_Object *obj, const char *key,
                                   const struct OpenAPI_Any *values,
                                   size_t n_values) {
 ...
 * @brief Autogenerated docstring
 */
int schema_ref_keyword(int is_dynamic, char **_out_val) {
  {
 ...
 * @brief Autogenerated docstring
 */
int write_request_body_object(JSON_Object *rb_obj,
 ...
 * @brief Autogenerated docstring
 */
void write_callback_object(JSON_Object *cb_obj,
 ...
 * @brief Autogenerated docstring
 */
int write_component_request_bodies(JSON_Object *components,
                                          const struct OpenAPI_Spec *spec) {
  JSON_Value *rbs_val;
  JSON_Object *rbs_obj;
  size_t i;
