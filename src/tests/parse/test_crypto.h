 ...
 * @brief Autogenerated docstring
 */
int test_sha256_empty_string(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sha256_known_string(TEST *_out_val) {
  unsigned char digest[CRYPTO_SHA256_SIZE];
  char hex[CRYPTO_SHA256_SIZE * 2 + 1];
 ...
 * @brief Autogenerated docstring
 */
int test_hmac_rfc4231_case1(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_hmac_rfc4231_case2(TEST *_out_val) {
  unsigned char mac[CRYPTO_SHA256_SIZE];
  char hex[CRYPTO_SHA256_SIZE * 2 + 1];
  /* Key: "Jefe" */
  const char *key = "Jefe";
 ...
 * @brief Autogenerated docstring
 */
int test_hmac_empty_keys_or_data(TEST *_out_val) {
  unsigned char mac[CRYPTO_SHA256_SIZE];
  const char *key = "key";
