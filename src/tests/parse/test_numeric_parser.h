 ...
 */
int dbl_eq(double a, double b) { return fabs(a - b) < 1e-9; }

/**
 * @brief Autogenerated docstring
 */
int test_parse_dec_int(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_parse_hex_int(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_bin_int(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_oct_int(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_int_suffixes(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_float_simple(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_float_exponent(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_float_suffix(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_decimal_float_suffixes(TEST *_out_val) {
  struct NumericValue nv;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_hex_float(TEST *_out_val) {
  struct NumericValue nv;
  /* 0x1.8p1 = 1.5 * 2^1 = 3.0 */
 ...
 * @brief Autogenerated docstring
 */
int test_parse_errors(TEST *_out_val) {
  struct NumericValue nv;
  /* Bad hex */
