 ...
 */
int test_get_basename(TEST *_out_val) {
  char *res = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_read_to_file_error(TEST *_out_val) {
  int rc;
  size_t size = 0;
  char *s = NULL;
 ...
 * @brief Autogenerated docstring
 */
int mock_walk_cb(const char *path, void *user_data) {
 ...
 * @brief Autogenerated docstring
 */
int test_walk_directory(TEST *_out_val) {
  /* Setup structure:
     walk_test_root/
       a.txt
       sub/
 ...
 * @brief Autogenerated docstring
 */
int test_makedir_check(TEST *_out_val) {
  char *t = NULL;
  char *p = NULL;
  tempdir(&t);
