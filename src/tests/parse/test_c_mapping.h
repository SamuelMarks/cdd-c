 ...
 */
int test_mapping_int(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_mapping_string(TEST *_out_val) {
  struct OpenApiTypeMapping m;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_mapping_struct_ref(TEST *_out_val) {
  struct OpenApiTypeMapping m;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_mapping_array(TEST *_out_val) {
  struct OpenApiTypeMapping m;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_mapping_bool(TEST *_out_val) {
  struct OpenApiTypeMapping m;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_mapping_long(TEST *_out_val) {
  struct OpenApiTypeMapping m;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_mapping_void_ptr(TEST *_out_val) {
  struct OpenApiTypeMapping m;
  int rc;
  /* void* -> string (binary) */
