 ...
 */
int token_to_cstr(char *buf, size_t buf_len, const struct Token *tok, char * *_out_val) {
  size_t copy_len;
  if (buf_len == 0)
 ...
 * @brief Autogenerated docstring
 */
int tokenize_all_tokens(TEST *_out_val) {
  const az_span code =
 ...
 * @brief Autogenerated docstring
 */
int tokenize_c23_digit_separators(TEST *_out_val) { char * _ast_token_to_cstr_0; char * _ast_token_to_cstr_1; char * _ast_token_to_cstr_2; 
  /* Test 123'456 */
 ...
 * @brief Autogenerated docstring
 */
int tokenize_digit_separator_edge_case(TEST *_out_val) { char * _ast_token_to_cstr_3; 
