...
";
  ...
  ASSERT_EQ(TOKEN_KEYWORD_INT, tokens->tokens[list.sites[0].start_token_idx].kind);
  ASSERT_EQ(TOKEN_SEMICOLON, tokens->tokens[list.sites[0].end_token_idx - 1].kind);
