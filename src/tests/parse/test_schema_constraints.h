 ...
 */
int test_schema_constraints_roundtrip(TEST *_out_val) {
  JSON_Value *val;
  JSON_Object *obj;
 ...
 * @brief Autogenerated docstring
 */
int test_schema_annotations_roundtrip(TEST *_out_val) {
  JSON_Value *val;
  JSON_Object *obj;
 ...
 * @brief Autogenerated docstring
 */
int test_schema_allof_merge(TEST *_out_val) {
  JSON_Value *root_val;
 ...
 * @brief Autogenerated docstring
 */
int test_schema_anyof_first_object(TEST *_out_val) {
  JSON_Value *schema_val;
 ...
 * @brief Autogenerated docstring
 */
int test_schema_oneof_first_object(TEST *_out_val) {
  JSON_Value *schema_val;
 ...
 * @brief Autogenerated docstring
 */
int test_schema_keyword_passthrough(TEST *_out_val) {
  JSON_Value *val;
  JSON_Object *obj;
  const char *schema =
      "{"
 ...
 * @brief Autogenerated docstring
 */
int test_schema_allof_keyword_merge(TEST *_out_val) {
  JSON_Value *schema_val;
  const char *schema = "{"
                       "\"allOf\":["
                       "{"
 ...
 * @brief Autogenerated docstring
 */
int test_schema_type_union_roundtrip(TEST *_out_val) {
  JSON_Value *val;
  JSON_Object *obj;
