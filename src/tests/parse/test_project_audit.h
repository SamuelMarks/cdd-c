 ...
 */
int test_audit_stats_init(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_audit_single_file(TEST *_out_val) {
  char *sys_tmp = NULL;
  char *root = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_audit_ignored_files(TEST *_out_val) {
  char *sys_tmp = NULL;
  char *root = NULL;
  char *f_h = NULL;
  struct AuditStats stats;
 ...
 * @brief Autogenerated docstring
 */
int test_audit_return_alloc(TEST *_out_val) {
  char *sys_tmp = NULL;
  char *root = NULL;
  char *f_ret = NULL;
  struct AuditStats stats;
 ...
 * @brief Autogenerated docstring
 */
int test_audit_json_output(TEST *_out_val) {
  struct AuditStats stats;
  char *json;
 ...
 * @brief Autogenerated docstring
 */
int test_audit_stats_null(TEST *_out_val) {
  struct AuditStats stats;
 ...
 * @brief Autogenerated docstring
 */
int test_audit_edge_cases(TEST *_out_val) {
  char *sys_tmp = NULL;
  char *root = NULL;
  char *f_noext = NULL;
  char *d_dir_c = NULL;
