 ...
 */
int load_spec_str(const char *json_str, struct OpenAPI_Spec *spec) {
 ...
 * @brief Autogenerated docstring
 */
int load_spec_str_with_context(const char *json_str,
 ...
 * @brief Autogenerated docstring
 */
int find_raw_schema_index(const struct OpenAPI_Spec *spec,
                                 const char *name) {
  size_t i;
  if (!spec || !name)
    return -1;
 ...
 * @brief Autogenerated docstring
 */
int find_scheme(const struct OpenAPI_Spec *spec, const char *name, struct OpenAPI_SecurityScheme * *_out_val) {
  size_t i;
  if (!spec || !name)
 ...
 * @brief Autogenerated docstring
 */
int find_media_type(const struct OpenAPI_MediaType *mts, size_t n,
                           const char *name,
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_array(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_parsing(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_external_docs_discriminator_xml(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_form_content_type(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_request_body_content_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_param_content_multiple_entries_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_header_content_multiple_entries_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_response_description_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_operation_responses_required(TEST *_out_val) {
  const char *json =
      "{\"openapi\":\"3.2.0\",\"info\":{\"title\":\"t\",\"version\":\"1\"},"
      "\"paths\":{\"/"
      "r\":{\"get\":{}}}}";
 ...
 * @brief Autogenerated docstring
 */
int test_response_code_key_invalid_rejected(TEST *_out_val) {
  const char *json =
      "{\"openapi\":\"3.2.0\",\"info\":{\"title\":\"t\",\"version\":\"1\"},"
 ...
 * @brief Autogenerated docstring
 */
int test_response_code_range_valid(TEST *_out_val) {
  const char *json =
      "{\"openapi\":\"3.2.0\",\"info\":{\"title\":\"t\",\"version\":\"1\"},"
 ...
 * @brief Autogenerated docstring
 */
int test_paths_require_leading_slash(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_paths_ambiguous_templates_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_component_key_regex_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_tag_duplicate_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_tag_name_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_tag_parent_missing_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_tag_parent_cycle_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_external_docs_url_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_operation_id_duplicate_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_operation_id_duplicate_in_callback_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_parameter_duplicates_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_querystring_with_query_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_querystring_duplicate_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_querystring_path_and_operation_mixed_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_querystring_with_query_in_callback_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_parameter_missing_name_or_in_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_header_style_non_simple_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_media_type_encoding_conflict_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_encoding_object_conflict_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_operation_tags(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_metadata(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_allow_empty_value(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_allow_empty_value_non_query_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_explode_false(TEST *_out_val) {
  const char *json =
      "{\"paths\":{\"/"
 ...
 * @brief Autogenerated docstring
 */
int test_load_querystring_parameter(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_querystring_json_inline_promoted(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_ignore_reserved_header_parameters(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_ignore_content_type_response_header(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_param_schema_and_content_conflict(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_header_schema_and_content_conflict(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_content_any(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_content_media_type_encoding(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_header_content_media_type(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_schema_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_header_schema_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_level_parameters(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_server_variables(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_server_variable_default_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_openapi_version_and_servers(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_server_duplicate_name_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_missing_openapi_and_swagger_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_root_document_with_id(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_root_boolean(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_swagger_root_allowed(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_openapi_version_unsupported_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_server_url_query_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_requirements(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_schemes(TEST *_out_val) { struct OpenAPI_SecurityScheme * _ast_find_scheme_0; struct OpenAPI_SecurityScheme * _ast_find_scheme_1; struct OpenAPI_SecurityScheme * _ast_find_scheme_2; 
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_scheme_deprecated(TEST *_out_val) { struct OpenAPI_SecurityScheme * _ast_find_scheme_3; 
 ...
 * @brief Autogenerated docstring
 */
int test_load_oauth2_flows(TEST *_out_val) { struct OpenAPI_SecurityScheme * _ast_find_scheme_4; 
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_scheme_http_missing_scheme_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_scheme_apikey_missing_name_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_scheme_apikey_missing_in_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_security_scheme_openid_missing_url_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_oauth2_missing_flows_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_oauth2_flow_missing_scopes_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_oauth2_flow_missing_required_urls_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_oauth2_flow_unknown_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_examples_object(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_examples_media(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_example_and_examples_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_header_example_and_examples_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_media_example_and_examples_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_example_data_value_and_value_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_example_serialized_and_external_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_response_examples_media(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_component_examples(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_example_component_ref_strict(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_request_body_metadata_and_response_description(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_request_body_component_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_response_multiple_content(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_request_body_multiple_content_with_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_media_type_encoding(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_media_type_prefix_item_encoding(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_info_metadata(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_info_missing_title_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_info_missing_version_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_license_identifier_and_url_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_license_missing_name_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_operation_metadata(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_response_content_type(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_response_content_type_specificity(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_response_content_type_params_json(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_response_schema_primitive(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_response_schema_array(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_format_and_content(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_array_item_format_and_content(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_const_examples_annotations(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_ref_summary_description(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_parameter_schema_format_and_content(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_enum_default_nullable(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_type_union(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_array_items_enum_nullable(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_items_type_union(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_boolean_and_numeric_enum(TEST *_out_val) {
  const char *json = "{\"openapi\":\"3.2.0\",\"info\":{\"title\":\"t\","
                     "\"version\":\"1\"},\"paths\":{\"/p\":{\"get\":{"
                     "\"parameters\":["
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_items_examples_and_boolean_items(TEST *_out_val) {
  const char *json =
      "{\"paths\":{\"/"
      "p\":{\"get\":{\"parameters\":[{\"name\":\"tags\",\"in\":\"query\","
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_example_and_numeric_constraints(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_array_constraints_and_items_example(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_schema_items_const_default_and_extras(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_request_body_object_promoted(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_request_body_item_schema_array(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_response_schema_object_item_promoted(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_inline_response_item_schema_object_promoted(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_request_body_ref_description_override(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_options_trace_verbs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_root_metadata_and_tags(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_self_qualified_component_refs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_relative_self_component_refs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_schema_id_ref_resolution(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_schema_anchor_ref_resolution(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_schema_dynamic_ref_resolution(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_external_component_ref_registry_absolute(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_external_component_ref_registry_relative(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_query_verb_and_external_docs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_and_operation_servers(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_webhooks(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_component_parameter_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_component_response_and_headers(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_additional_operations(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_component_media_type_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_component_path_items(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_response_links_and_component_links(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_callbacks_and_component_callbacks(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_item_ref_resolves_component(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_callback_ref_resolves_component(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_extensions_non_schema(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_paths_webhooks_components_extensions(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_webhook_path_template_not_validated(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_component_schema_raw(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_external_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_ref_with_pointer_is_not_component(TEST *_out_val) {
  const char *json = "{"
                     "\"openapi\":\"3.2.0\","
                     "\"info\":{\"title\":\"T\",\"version\":\"1\"},"
                     "\"paths\":{\"/pets\":{\"get\":{\"responses\":{\"200\":{"
 ...
 * @brief Autogenerated docstring
 */
int test_load_schema_external_items_ref(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_template_missing_param(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_template_param_not_in_route(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_path_template_param_not_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_root_missing_paths_components_webhooks_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_param_style_invalid_for_in_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_param_style_deep_object_scalar_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_server_url_variable_missing_definition_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_server_url_variable_duplicate_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_server_missing_url_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_additional_operations_standard_method_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_link_missing_operation_ref_or_id_rejected(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_load_link_operation_ref_and_id_both_rejected(TEST *_out_val) {
