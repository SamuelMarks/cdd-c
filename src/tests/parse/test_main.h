 ...
 */
int test_main_no_args(TEST *_out_val) {
  char *argv[] = {"cdd-c"};
 ...
 * @brief Autogenerated docstring
 */
int test_main_help(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_main_version(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_main_invalid_command(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_main_subcommands(TEST *_out_val) {
