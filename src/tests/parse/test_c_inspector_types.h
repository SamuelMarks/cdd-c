 ...
 */
int test_scan_c23_enum_fixed_type(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_scan_c23_enum_fixed_type_whitespace(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_scan_classic_enum(TEST *_out_val) {
