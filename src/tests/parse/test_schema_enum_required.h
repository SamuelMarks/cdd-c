 ...
 */
int load_spec_string(const char *json, struct OpenAPI_Spec *spec) {
  JSON_Value *root;
  int rc;
  if (!json || !spec)
    return -1;
 ...
 * @brief Autogenerated docstring
 */
int test_loader_enum_and_required(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_writer_enum_and_required(TEST *_out_val) {
  /* */
...
int schema_enum_required_suite) {
