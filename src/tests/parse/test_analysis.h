 ...
 */
int setup_analysis_tokens(const char *code, struct TokenList * *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_find_simple_unchecked_malloc(TEST *_out_val) { struct TokenList * _ast_setup_analysis_tokens_0; 
  struct TokenList *tl = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_find_simple_checked_malloc(TEST *_out_val) { struct TokenList * _ast_setup_analysis_tokens_1; 
  struct TokenList *tl = NULL;
  struct AllocationSiteList sites = {0};
  const char *code = "/**
 * @brief Autogenerated docstring
 ...
 * @brief Autogenerated docstring
 */
int test_alloc_inside_condition(TEST *_out_val) { struct TokenList * _ast_setup_analysis_tokens_2; 
  struct TokenList *tl = NULL;
  struct AllocationSiteList sites = {0};
 ...
 * @brief Autogenerated docstring
 */
int test_find_return_alloc(TEST *_out_val) { struct TokenList * _ast_setup_analysis_tokens_3; 
  struct TokenList *tl = NULL;
  struct AllocationSiteList sites = {0};
 ...
 * @brief Autogenerated docstring
 */
int test_asprintf_unchecked(TEST *_out_val) { struct TokenList * _ast_setup_analysis_tokens_4; 
  struct TokenList *tl = NULL;
  struct AllocationSiteList sites = {0};
  const char *code = "/**
 * @brief Autogenerated docstring
 ...
 * @brief Autogenerated docstring
 */
int test_init_free_safety(TEST *_out_val) {
