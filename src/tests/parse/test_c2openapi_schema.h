 ...
 */
int test_register_single_struct(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_register_deduplication(TEST *_out_val) {
  struct OpenAPI_Spec spec;
  struct TypeDefList types;
 ...
 * @brief Autogenerated docstring
 */
int test_register_multiple_structs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_register_null_safety(TEST *_out_val) {
  struct OpenAPI_Spec spec;
  struct TypeDefList types;
 ...
 * @brief Autogenerated docstring
 */
int test_register_enum_schema(TEST *_out_val) {
