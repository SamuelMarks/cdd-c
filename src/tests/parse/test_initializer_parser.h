 ...
 */
int tokenize_str(const char *s, struct TokenList * *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_init_simple_positional(TEST *_out_val) { struct TokenList * _ast_tokenize_str_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_init_designated_fields(TEST *_out_val) { struct TokenList * _ast_tokenize_str_1; 
 ...
 * @brief Autogenerated docstring
 */
int test_init_array_index(TEST *_out_val) { struct TokenList * _ast_tokenize_str_2; 
 ...
 * @brief Autogenerated docstring
 */
int test_init_nested(TEST *_out_val) { struct TokenList * _ast_tokenize_str_3; 
 ...
 * @brief Autogenerated docstring
 */
int test_init_mixed_expressions(TEST *_out_val) { struct TokenList * _ast_tokenize_str_4; 
 ...
 * @brief Autogenerated docstring
 */
int test_init_trailing_comma(TEST *_out_val) { struct TokenList * _ast_tokenize_str_5; 
  const char *code = "{ 1, }";
 ...
 * @brief Autogenerated docstring
 */
int test_init_errors(TEST *_out_val) { struct TokenList * _ast_tokenize_str_6; struct TokenList * _ast_tokenize_str_7; 
  struct TokenList *tl;
  struct InitList list;
