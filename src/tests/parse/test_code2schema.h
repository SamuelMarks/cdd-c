 ...
 */
int test_write_enum_functions(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_struct_fields_manage(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_str_starts_with(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_parse_struct_member_line(TEST *_out_val) {
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_struct_member_bitfield(TEST *_out_val) {
  struct StructFields sf;
  struct_fields_init(&sf);
 ...
 * @brief Autogenerated docstring
 */
int test_parse_struct_member_format_mapping(TEST *_out_val) {
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_write_struct_functions(TEST *_out_val) {
  FILE *tmpf = tmpfile();
 ...
 * @brief Autogenerated docstring
 */
int test_struct_fields_overflow(TEST *_out_val) {
  struct StructFields sf;
  unsigned char i;
  enum { n = 32 };
  ASSERT_EQ(0, struct_fields_init(&sf));
 ...
 * @brief Autogenerated docstring
 */
int test_enum_members_overflow(TEST *_out_val) {
  struct EnumMembers em;
  unsigned char i;
  enum { n = 32 };
  ASSERT_EQ(0, enum_members_init(&em));
 ...
 * @brief Autogenerated docstring
 */
int test_trim_trailing(TEST *_out_val) {
  enum { n = 32 };
  char a[n];
#if defined(_MSC_VER) && !defined(__INTEL_COMPILER) ||                         \
    defined(__STDC_LIB_EXT1__) && __STDC_WANT_LIB_EXT1__
 ...
 * @brief Autogenerated docstring
 */
int test_code2schema_main_bad_args(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_code2schema_parsing_details(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_code2schema_parse_struct_and_enum(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_code2schema_file_not_found(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_codegen_enum_null_args(TEST *_out_val) {
  FILE *tmp = tmpfile();
 ...
 * @brief Autogenerated docstring
 */
int test_codegen_enum_with_unknown(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct EnumMembers em;
 ...
 * @brief Autogenerated docstring
 */
int test_codegen_all_field_types(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_codegen_empty_struct_and_enum(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct EnumMembers em;
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_codegen_struct_null_args(TEST *_out_val) {
  FILE *tmp = tmpfile();
