 ...
 */
int test_orchestrator_simple_propagation(TEST *_out_val) {
  /*
 ...
 * @brief Autogenerated docstring
 */
int test_orchestrator_propagation_ptr(TEST *_out_val) {
  /*
 ...
 * @brief Autogenerated docstring
 */
int test_orchestrator_main_stop(TEST *_out_val) {
  /*
     A returns void, allocs.
     main calls A.
     Refactor: A -> int.
 ...
 * @brief Autogenerated docstring
 */
int test_orchestrator_no_alloc(TEST *_out_val) {
  const char *input = "/**
 * @brief Autogenerated docstring
 */
void A() { int x=1; }";
 ...
 * @brief Autogenerated docstring
 */
int test_orchestrator_preserves_structs(TEST *_out_val) {
  /* Ensure non-function nodes like structs are preserved */
  const char *input = "struct S { int x; }; /**
 * @brief Autogenerated docstring
 */
int f() { return 0; }";
  char *out = NULL;
...
int refactor_orchestrator_suite) {
