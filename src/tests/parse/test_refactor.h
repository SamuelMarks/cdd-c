 ...
 */
int test_refactor_context_lifecycle(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_apply_refactoring_to_string_basic(TEST *_out_val) {
  struct RefactorContext ctx;
  int rc;
  const char *src = "/**
 * @brief Autogenerated docstring
 ...
 * @brief Autogenerated docstring
 */
int test_apply_refactoring_to_string_errors(TEST *_out_val) {
