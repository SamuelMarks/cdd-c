 ...
 */
int test_parse_fam_basic(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_parse_fam_int(TEST *_out_val) {
  struct StructFields sf;
  struct StructField *f;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_ptr_not_fam(TEST *_out_val) {
  struct StructFields sf;
  struct StructField *f;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_fixed_array_not_fam(TEST *_out_val) {
  struct StructFields sf;
  struct StructField *f;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_parse_fam_mixed_lines(TEST *_out_val) {
  struct StructFields sf;
  int rc;
