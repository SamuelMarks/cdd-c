 ...
 */
struct TokenList * setup_tokens(const char *code) {
 ...
 * @brief Autogenerated docstring
 */
enum greatest_test_res verify_chain(struct DeclType *head, int n, ...) {
  va_list args;
  int i;
 ...
 * @brief Autogenerated docstring
 */
TEST test_parse_basic_int(void) { const char *code = "int x";
 ...
 * @brief Autogenerated docstring
 */
TEST test_parse_ptr(void) { const char *code = "char *p";
  struct TokenList *tl = setup_tokens(code);
  struct DeclInfo info;
  int rc;
