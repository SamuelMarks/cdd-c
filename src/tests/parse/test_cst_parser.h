 ...
 */
void make_simple_token_list(struct TokenList *tl) {
 ...
 * @brief Autogenerated docstring
 */
int add_node_basic(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int parse_tokens_basic(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int parse_tokens_empty(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int parse_tokens_null_args(TEST *_out_val) {
  struct TokenList tokens = {NULL, 0, 0};
  struct CstNodeList cst_nodes = {NULL, 0, 0};
 ...
 * @brief Autogenerated docstring
 */
int parse_tokens_forward_declaration(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int parse_tokens_anonymous_struct(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_tokens_struct_variable_declaration(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_simple_array_init(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_compound_literal(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_control_block_split(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_nested_compound_literal(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_return_compound(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
 ...
 * @brief Autogenerated docstring
 */
int parse_c11_generic(TEST *_out_val) {
  struct TokenList *tl = NULL;
  struct CstNodeList cst = {0};
  /* _Generic selection */
  const az_span code =
