 ...
 */
int test_c2openapi_full_flow(TEST *_out_val) {
  char *tmp_dir = NULL;
  char *src_dir = NULL;
  char *c_file = NULL;
  char *h_file = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_c2openapi_with_base_spec(TEST *_out_val) {
  char *tmp_dir = NULL;
  char *src_dir = NULL;
  char *c_file = NULL;
  char *h_file = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_c2openapi_with_self_uri(TEST *_out_val) {
  char *tmp_dir = NULL;
  char *src_dir = NULL;
  char *c_file = NULL;
  char *h_file = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_c2openapi_global_meta_security_schemes(TEST *_out_val) {
  char *tmp_dir = NULL;
  char *src_dir = NULL;
  char *c_file = NULL;
  char *out_json = NULL;
...
int integration_c2openapi_suite) {
