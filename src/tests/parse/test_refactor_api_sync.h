 ...
 */
int load_spec(const char *json, struct OpenAPI_Spec *spec) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_signature_update(TEST *_out_val) {
  /* SKIPm("fix me"); */
 ...
 * @brief Autogenerated docstring
 */
int test_sync_url_logic_update(TEST *_out_val) {
  /* SKIPm("fix me"); */
 ...
 * @brief Autogenerated docstring
 */
int test_sync_query_update(TEST *_out_val) {
  /* SKIPm("fix me"); */
 ...
 * @brief Autogenerated docstring
 */
int test_sync_header_update(TEST *_out_val) {
  /* SKIPm("fix me"); */
