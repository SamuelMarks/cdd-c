 ...
 */
int mock_cb(const struct IncludeInfo *info, void *user_data) {
 ...
 * @brief Autogenerated docstring
 */
int eval(const char *expr, struct PreprocessorContext *ctx, long *out) {
 ...
 * @brief Autogenerated docstring
 */
int test_pp_eval_arithmetic(TEST *_out_val) {
  {
    long out = 0;
    eval("1 + 1", NULL, &out);
    ASSERT_EQ(2, out);
 ...
 * @brief Autogenerated docstring
 */
int test_pp_eval_logical(TEST *_out_val) {
  {
    long out = 0;
    eval("1 && 1", NULL, &out);
    ASSERT_EQ(1, out);
 ...
 * @brief Autogenerated docstring
 */
int test_pp_eval_comparison(TEST *_out_val) {
  {
    long out = 0;
    eval("1 == 1", NULL, &out);
    ASSERT_EQ(1, out);
 ...
 * @brief Autogenerated docstring
 */
int test_pp_eval_defined(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_pp_eval_macros_as_values(TEST *_out_val) {
  struct PreprocessorContext ctx;
  pp_context_init(&ctx);
 ...
 * @brief Autogenerated docstring
 */
int test_pp_has_include(TEST *_out_val) {
  struct PreprocessorContext ctx;
  char *tmp = NULL;
  char *root = NULL;
  char *h = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_pp_embed_params_parsing(TEST *_out_val) {
  struct PreprocessorContext ctx;
 ...
 * @brief Autogenerated docstring
 */
int test_pp_ifdef_skip(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_pp_if_else(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_pp_nested_if(TEST *_out_val) {
