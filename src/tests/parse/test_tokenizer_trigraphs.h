 ...
 */
int tokenize_string(const char *s, struct TokenList * *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_trigraph_basic(TEST *_out_val) { struct TokenList * _ast_tokenize_string_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_splice_basic(TEST *_out_val) { struct TokenList * _ast_tokenize_string_1; 
 ...
 * @brief Autogenerated docstring
 */
int test_trigraph_splice_interaction(TEST *_out_val) { struct TokenList * _ast_tokenize_string_2; 
 ...
 * @brief Autogenerated docstring
 */
int test_splice_does_not_create_trigraph(TEST *_out_val) { struct TokenList * _ast_tokenize_string_3; 
 ...
 * @brief Autogenerated docstring
 */
int test_matches_string_with_splice(TEST *_out_val) { struct TokenList * _ast_tokenize_string_4; 
