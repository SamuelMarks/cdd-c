 ...
 */
int test_enum_tank_to_str_and_from_str(TEST *_out_val) {
  char *str = NULL;
  enum Tank tank_val;
 ...
 * @brief Autogenerated docstring
 */
int test_HazE_to_json_and_from_json(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_FooE_to_json_and_from_json_with_null_haz(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_FooE_to_json_and_from_json_non_null_haz(TEST *_out_val) {
