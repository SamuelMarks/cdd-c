 ...
 * @brief Autogenerated docstring
 */
int test_recursive_cleanup(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_recursive_deepcopy(TEST *_out_val) {
  struct Node * head = (struct Node *)malloc(sizeof(struct Node));
  struct Node * next = (struct Node *)malloc(sizeof(struct Node));
 ...
 * @brief Autogenerated docstring
 */
int test_recursive_eq(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_FooE_default_deepcopy_eq_cleanup(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_HazE_default_deepcopy_eq_cleanup(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_FooE_json_roundtrip(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_HazE_json_roundtrip(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_json_parsing_errors(TEST *_out_val) {
  struct HazE *h = NULL;
  struct FooE *f = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_json_parsing_corner_cases(TEST *_out_val) {
  struct HazE *h = NULL;
  struct FooE *f = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_null_args_and_errors(TEST *_out_val) {
  char *str = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_debug_and_display(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_display_fail(TEST *_out_val) {
  struct FooE *foo = NULL;
  struct HazE *haz = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_eq_null_cases(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_Tank_to_str_from_str(TEST *_out_val) {
  char *str = NULL;
  enum Tank val;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_cleanup_null(TEST *_out_val) {
  FooE_cleanup(NULL);
  HazE_cleanup(NULL);
  PASS();
}
 ...
 * @brief Autogenerated docstring
 */
int test_to_json_with_null_fields(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_debug_fail(TEST *_out_val) {
  struct FooE *foo = NULL;
  struct HazE *haz = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_json_parsing_wrong_types(TEST *_out_val) {
  struct FooE *f = NULL;
  struct HazE *h = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_deepcopy_null_fields(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_json_parsing_missing_fields(TEST *_out_val) {
  struct FooE *f = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_debug_with_null_nested(TEST *_out_val) {
  struct FooE *f = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_debug_with_empty_strings(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_HazE_deepcopy_alloc_fail(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_simple_json_HazE_more_eq_cases(TEST *_out_val) {
  struct HazE *h1 = NULL, *h2 = NULL;
  HazE_default(&h1);
  HazE_default(&h2);
 ...
 * @brief Autogenerated docstring
 */
int test_simple_json_more_eq_cases(TEST *_out_val) {
  struct FooE *f1 = NULL, *f2 = NULL;
  FooE_default(&f1);
  FooE_default(&f2);
 ...
 * @brief Autogenerated docstring
 */
int test_FooE_eq_nested_diff(TEST *_out_val) {
  struct FooE *f1 = NULL, *f2 = NULL;
  FooE_default(&f1);
  FooE_default(&f2);
