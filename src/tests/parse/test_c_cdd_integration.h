 ...
 */
int test_integration_full_pipeline(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_integration_fix_file_io(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_integration_recursive_fix(TEST *_out_val) {
  char *sys_tmp = NULL;
  char *root = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_integration_fix_file_in_place(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_integration_fix_dir_error_no_flag(TEST *_out_val) {
  char *sys_tmp = NULL;
  char *root = NULL;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_end_to_end_project_lifecycle(TEST *_out_val) {
  char *sys_tmp = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_integration_schema2code_with_guards(TEST *_out_val) {
  /*
   * Tests:
