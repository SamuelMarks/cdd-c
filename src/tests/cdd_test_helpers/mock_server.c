 ...
 * @brief Autogenerated docstring
 */
void cond_init(HANDLE *c) { *c = CreateEvent(NULL, FALSE, FALSE, NULL); }
static /**
 * @brief Autogenerated docstring
 */
void cond_signal(HANDLE *c) { SetEvent(*c); }
static /**
 * @brief Autogenerated docstring
 */
int cond_wait(HANDLE *c, mutex_t *m) { LeaveCriticalSection(m); WaitForSingleObject(*c, INFINITE); EnterCriticalSection(m); return 0; }
#else
static /**
 * @brief Autogenerated docstring
 */
 ...
 * @brief Autogenerated docstring
 */
int server_thread_func(THREAD_FUNC_ARG arg, THREAD_FUNC_RETURN *_out_val) {
