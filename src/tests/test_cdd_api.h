...
TEST test_cdd_generate_from_openapi(void) {
  ...
  config.input = (char *)(size_t)(size_t)(size_t) "nonexistent.json";
  config.output = (char *)(size_t)(size_t)(size_t) "out";
  config.subcommand = (char *)(size_t)(size_t)(size_t) "to_sdk";
  cdd_generate_from_openapi(&config);

  config.subcommand = NULL;
  config.input = NULL;
  config.input_dir = (char *)(size_t)(size_t)(size_t) "nonexistent_dir";
...
TEST test_cdd_generate_to_openapi(void) {
  ...
  config.input = (char *)(size_t)(size_t)(size_t) "nonexistent.c";
  config.output = (char *)(size_t)(size_t)(size_t) "out.json";
...
TEST test_cdd_serve_json_rpc(void) {
  ...
  config.listen_host = (char *)(size_t)(size_t)(size_t) "255";
...
TEST test_cdd_generate_bindings(void) {
  ...
  config.input = (char *)(size_t)(size_t)(size_t) "input";
  ASSERT_EQ(CDD_C_ERROR_UNKNOWN, cdd_generate_bindings(&config));
  config.output_dir = (char *)(size_t)(size_t)(size_t) "out";
  ASSERT_EQ(CDD_C_ERROR_UNKNOWN, cdd_generate_bindings(&config));

  config.input = (char *)(size_t)(size_t)(size_t) "nonexistent.c";
  config.output_dir = (char *)(size_t)(size_t)(size_t) "out_dir";
  config.target_langs = (char *)(size_t)(size_t)(size_t) "all";
  /* Read file failure */
  ...
  config.input = (char *)(size_t)(size_t)(size_t) "test_dummy_bindings.h";
  ...
  config.output_dir = (char *)(size_t)(size_t)(size_t) "test_bindings_out";
