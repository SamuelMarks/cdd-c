 ...
 */
void to_c_ident(char *out, const size_t outsz, const char *const in) {
  size_t i;
 ...
 * @brief Autogenerated docstring
 */
int write_test_enum(FILE *f, const char *const enum_name,
 ...
 * @brief Autogenerated docstring
 */
int write_test_struct(FILE *f, const char *const struct_name,
