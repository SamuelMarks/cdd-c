 ...
 */
int test_gen_cmake_basic(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_gen_cmake_with_tests(TEST *_out_val) {
  const char *out_file = "test_build_dir/CMakeLists.txt";
  char *content;
  size_t sz;
  int rc;
 ...
 * @brief Autogenerated docstring
 */
int test_gen_build_system_cli_args(TEST *_out_val) {
  char arg0[] = "cmake";
 ...
 * @brief Autogenerated docstring
 */
int test_gen_build_system_bad_args(TEST *_out_val) {
...
int generate_build_system_suite) {
