 ...
 */
void setup_struct_fields(struct StructFields *sf) {
 ...
 * @brief Autogenerated docstring
 */
int test_cleanup_generation(TEST *_out_val) {
  FILE *tmp = tmpfile();
 ...
 * @brief Autogenerated docstring
 */
int test_default_generation(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_deepcopy_generation(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_eq_generation(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_guards_injection(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_null_args(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_struct_fields_add_bitwidth(TEST *_out_val) {
  struct StructFields sf;
  struct_fields_init(&sf);
