 ...
 */
int test_sync_code_wrong_args(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_main_argc(TEST *_out_val) {
  char *argv[] = {"foo.h"};
  ASSERT_EQ(EXIT_FAILURE, sync_code_main(1, argv));
  PASS();
}
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_file_missing(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_simple_struct_enum(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_empty_header(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_no_struct_or_enum(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_impl_file_cannot_open(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_too_many_defs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_sync_code_unterminated_defs(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_patch_header_basic(TEST *_out_val) {
  /*
     Header: /**
 * @brief Autogenerated docstring
 */
 ...
 * @brief Autogenerated docstring
 */
int test_patch_header_ptr_arg(TEST *_out_val) {
  /*
    Header: char* bar(int x);
    Source: /**
 * @brief Autogenerated docstring
 */
int bar(int x, char **out) { ... }
  */
 ...
 * @brief Autogenerated docstring
 */
int test_patch_header_ignore_others(TEST *_out_val) {
  /*
