 ...
 */
int test_wininet_lifecycle(TEST *_out_val) {
#ifdef _WIN32
 ...
 * @brief Autogenerated docstring
 */
int test_wininet_config_apply(TEST *_out_val) {
#ifdef _WIN32
  struct HttpTransportContext *ctx = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_wininet_send_validation(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_wininet_stubs(TEST *_out_val) {
#ifndef _WIN32
  struct HttpTransportContext *ctx = NULL;
