 ...
 */
int test_weaver_wrap_ifdef_basic(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_weaver_wrap_ifdef_else(TEST *_out_val) {
  struct PatchList patches;
  struct TokenList *tokens = NULL;
  const char *src = "int a = 5;";
  int res;
 ...
 * @brief Autogenerated docstring
 */
int test_weaver_wrap_ifdef_invalid_args(TEST *_out_val) {
  struct PatchList patches;
 ...
 * @brief Autogenerated docstring
 */
int test_weaver_inject_msvc_headers(TEST *_out_val) {
  struct PatchList patches;
  struct TokenList *tokens = NULL;
 ...
 * @brief Autogenerated docstring
 */
int main() { { *_out_val = 0; return 0; } }", out_code);
 ...
 * @brief Autogenerated docstring
 */
int test_weaver_vla_to_alloca(TEST *_out_val) {
  struct PatchList patches;
  struct TokenList *tokens = NULL;
  const char *src = "/**
 * @brief Autogenerated docstring
