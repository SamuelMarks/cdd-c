 ...
 */
int test_root_int_array_from_json(TEST *_out_val) { char * _ast_generate_ra_code_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_root_string_array_from_json(TEST *_out_val) { char * _ast_generate_ra_code_1; 
 ...
 * @brief Autogenerated docstring
 */
int test_root_obj_array_from_json(TEST *_out_val) { char * _ast_generate_ra_code_2; 
 ...
 * @brief Autogenerated docstring
 */
int test_root_int_array_to_json(TEST *_out_val) { char * _ast_generate_ra_code_3; 
 ...
 * @brief Autogenerated docstring
 */
int test_root_obj_array_to_json(TEST *_out_val) { char * _ast_generate_ra_code_4; 
 ...
 * @brief Autogenerated docstring
 */
int test_root_array_cleanup(TEST *_out_val) { char * _ast_generate_ra_code_5; char * _ast_generate_ra_code_6; 
  /* String cleanup */
