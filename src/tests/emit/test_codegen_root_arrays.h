 ...
 */
static int generate_ra_code(int (*fn)(FILE *, const char *, const char *, const char *,
...
TEST test_root_int_array_from_json(void) { char * _ast_generate_ra_code_0; 
  char *code = (generate_ra_code(write_root_array_from_json_func, "IntList",
                                "integer", NULL, &_ast_generate_ra_code_0), _ast_generate_ra_code_0);
  ASSERT(code);
  /* Check signature */
  ASSERT(strstr(
...
TEST test_root_string_array_from_json(void) { char * _ast_generate_ra_code_1; 
  char *code = (generate_ra_code(write_root_array_from_json_func, "StrList",
                                "string", NULL, &_ast_generate_ra_code_1), _ast_generate_ra_code_1);
  ASSERT(code);
  /* Signature: char ***out */
  ASSERT(strstr(
      code,
...
TEST test_root_obj_array_from_json(void) { char * _ast_generate_ra_code_2; 
  /* Array of objects references "MyObj" */
  char *code = (generate_ra_code(write_root_array_from_json_func, "ObjList",
                                "object", "MyObj", &_ast_generate_ra_code_2), _ast_generate_ra_code_2);
  ASSERT(code);
...
TEST test_root_int_array_to_json(void) { char * _ast_generate_ra_code_3; 
  char *code = (generate_ra_code(write_root_array_to_json_func, "IntList",
                                "integer", NULL, &_ast_generate_ra_code_3), _ast_generate_ra_code_3);
  ASSERT(code);
  ASSERT(strstr(
...
TEST test_root_obj_array_to_json(void) { char * _ast_generate_ra_code_4; 
  char *code = (generate_ra_code(write_root_array_to_json_func, "ObjList",
                                "object", "MyObj", &_ast_generate_ra_code_4), _ast_generate_ra_code_4);
  ASSERT(code);
...
TEST test_root_array_cleanup(void) { char * _ast_generate_ra_code_5; char * _ast_generate_ra_code_6; 
  /* String cleanup */
  char *code = (generate_ra_code(write_root_array_cleanup_func, "StrList",
                                "string", NULL, &_ast_generate_ra_code_5), _ast_generate_ra_code_5);
  ASSERT(code);
  ...
  code = (generate_ra_code(write_root_array_cleanup_func, "IntList", "integer",
                          NULL, &_ast_generate_ra_code_6), _ast_generate_ra_code_6);
  ASSERT(code);
  ASSERT(strstr(code, "free(in)"));
  free(code);
  PASS();
