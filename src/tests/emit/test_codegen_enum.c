 ...
 */
void setup_basic_enum(struct EnumMembers *em) {
 ...
 * @brief Autogenerated docstring
 */
int test_enum_to_str_basic(TEST *_out_val) {
  FILE *tmp = tmpfile();
 ...
 * @brief Autogenerated docstring
 */
int test_enum_from_str_basic(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct EnumMembers em;
  long sz;
  char *content;
 ...
 * @brief Autogenerated docstring
 */
int test_enum_guards(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct EnumMembers em;
 ...
 * @brief Autogenerated docstring
 */
int test_enum_null_safety(TEST *_out_val) {
  struct EnumMembers em;
