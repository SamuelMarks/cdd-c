 ...
 */
void dummy_op(struct OpenAPI_Operation *op, const char *id) {
 ...
 * @brief Autogenerated docstring
 */
int test_aggregator_add_new(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_aggregator_merge_paths(TEST *_out_val) {
  struct OpenAPI_Spec spec;
 ...
 * @brief Autogenerated docstring
 */
int test_aggregator_distinct_paths(TEST *_out_val) {
  struct OpenAPI_Spec spec;
  struct OpenAPI_Operation op1, op2;
 ...
 * @brief Autogenerated docstring
 */
int test_aggregator_add_additional_operation(TEST *_out_val) {
  struct OpenAPI_Spec spec;
  struct OpenAPI_Operation op = {0};
 ...
 * @brief Autogenerated docstring
 */
int test_aggregator_add_webhook(TEST *_out_val) {
  struct OpenAPI_Spec spec;
  struct OpenAPI_Operation op = {0};
 ...
 * @brief Autogenerated docstring
 */
int test_aggregator_bad_args(TEST *_out_val) {
  struct OpenAPI_Spec spec;
  struct OpenAPI_Operation op = {0};
  openapi_spec_init(&spec);
  dummy_op(&op, "x");
