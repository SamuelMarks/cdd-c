 ...
 */
int gen_parse_code(const char *name, struct StructFields *sf, char * *_out_val) {
  FILE *tmp = tmpfile();
  long sz;
  char *content;
 ...
 * @brief Autogenerated docstring
 */
int test_int_min_validation(TEST *_out_val) { char * _ast_gen_parse_code_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_int_exclusive_min(TEST *_out_val) { char * _ast_gen_parse_code_1; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_double_max_validation(TEST *_out_val) { char * _ast_gen_parse_code_2; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_double_exclusive_max(TEST *_out_val) { char * _ast_gen_parse_code_3; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_min_and_max(TEST *_out_val) { char * _ast_gen_parse_code_4; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_string_len_validation(TEST *_out_val) { char * _ast_gen_parse_code_5; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_string_simple_pattern_prefix(TEST *_out_val) { char * _ast_gen_parse_code_6; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_string_simple_pattern_suffix(TEST *_out_val) { char * _ast_gen_parse_code_7; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_string_simple_pattern_exact(TEST *_out_val) { char * _ast_gen_parse_code_8; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
 ...
 * @brief Autogenerated docstring
 */
int test_string_simple_pattern_contains(TEST *_out_val) { char * _ast_gen_parse_code_9; 
  struct StructFields sf;
  char *code;
  struct StructField *f;
