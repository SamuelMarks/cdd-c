 ...
 */
int test_multipart_lifecycle(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_multipart_flatten(TEST *_out_val) {
  struct HttpRequest req;
  char *content;
 ...
 * @brief Autogenerated docstring
 */
int test_multipart_part_headers(TEST *_out_val) {
  struct HttpRequest req;
  char *content;
 ...
 * @brief Autogenerated docstring
 */
int test_auth_basic_header(TEST *_out_val) {
  struct HttpRequest req;
  int rc;
