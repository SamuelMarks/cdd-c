 ...
 */
int test_server_json_rpc_bind_fail(TEST *_out_val) {
  #if defined(_WIN32)
  SOCKET server_fd;
#else
  int server_fd;
 ...
 * @brief Autogenerated docstring
 */
int test_server_json_rpc_listen_once(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_server_json_rpc_basic(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_server_json_rpc_bad_port(TEST *_out_val) {
