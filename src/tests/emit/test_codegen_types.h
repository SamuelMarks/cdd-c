 ...
 */
int test_write_union_to_json(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_write_union_from_json_object(TEST *_out_val) {
  struct StructFields sf;
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_write_union_from_json(TEST *_out_val) {
  struct StructFields sf;
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_write_union_array_to_json(TEST *_out_val) {
  struct StructFields sf;
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_write_union_array_from_json(TEST *_out_val) {
  struct StructFields sf;
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_write_union_array_cleanup(TEST *_out_val) {
  struct StructFields sf;
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_write_union_cleanup_switch(TEST *_out_val) {
  struct StructFields sf;
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_root_array_string_cleanup(TEST *_out_val) {
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_root_array_int_from_json(TEST *_out_val) {
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_root_array_obj_to_json(TEST *_out_val) {
  FILE *tmp = tmpfile();
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_union_guards(TEST *_out_val) {
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_types_null_args(TEST *_out_val) {
