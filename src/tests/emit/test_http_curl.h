 ...
 */
int setup_request(struct HttpRequest *req, int port) {
 ...
 * @brief Autogenerated docstring
 */
int test_curl_global_lifecycle(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_curl_context_lifecycle(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_curl_config_application(TEST *_out_val) {
  struct HttpTransportContext *ctx = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_curl_send_connection_failure(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_curl_send_invalid_arguments(TEST *_out_val) {
  struct HttpTransportContext *ctx = NULL;
  struct HttpResponse *res = NULL;
  struct HttpRequest req;
