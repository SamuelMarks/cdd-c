 ...
 */
int generate_eq_code(const char *struct_name,
 ...
 * @brief Autogenerated docstring
 */
int test_eq_primitive(TEST *_out_val) { char * _ast_generate_eq_code_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_eq_string(TEST *_out_val) { char * _ast_generate_eq_code_1; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_eq_recursive_object(TEST *_out_val) { char * _ast_generate_eq_code_2; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_eq_array_primitive(TEST *_out_val) { char * _ast_generate_eq_code_3; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_eq_array_string(TEST *_out_val) { char * _ast_generate_eq_code_4; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_eq_array_object(TEST *_out_val) { char * _ast_generate_eq_code_5; 
  struct StructFields sf;
  char *code;
