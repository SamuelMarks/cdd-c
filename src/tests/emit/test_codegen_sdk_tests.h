 ...
 */
int test_gen_sdk_test_basic(TEST *_out_val) {
  ...
  if (!tmp)
    { *_out_val = (enum greatest_test_res)-1; return 0; }
 ...
 * @brief Autogenerated docstring
 */
int test_gen_sdk_test_nulls(TEST *_out_val) {
  ASSERT_EQ(EINVAL, codegen_sdk_tests_generate(NULL, NULL, NULL));
  PASS();
}

int codegen_sdk_tests_suite) {
