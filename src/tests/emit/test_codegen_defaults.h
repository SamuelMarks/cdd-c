 ...
 */
int generate_def_code(const char *struct_name,
 ...
 * @brief Autogenerated docstring
 */
int test_default_primitive(TEST *_out_val) { char * _ast_generate_def_code_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_default_string(TEST *_out_val) { char * _ast_generate_def_code_1; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_default_enum(TEST *_out_val) { char * _ast_generate_def_code_2; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_default_no_defaults(TEST *_out_val) { char * _ast_generate_def_code_3; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_default_nullptr(TEST *_out_val) { char * _ast_generate_def_code_4; 
  struct StructFields sf;
  char *code;
 ...
 * @brief Autogenerated docstring
 */
int test_default_binary_literal(TEST *_out_val) { char * _ast_generate_def_code_5; 
  struct StructFields sf;
  char *code;
