 ...
 */
int setup_patch_tokens(const char *code, struct TokenList * *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_patch_init_free(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_patch_basic_replacement(TEST *_out_val) { struct TokenList * _ast_setup_patch_tokens_0; 
 ...
 * @brief Autogenerated docstring
 */
int test_patch_insertion(TEST *_out_val) { struct TokenList * _ast_setup_patch_tokens_1; 
 ...
 * @brief Autogenerated docstring
 */
int test_patch_deletion(TEST *_out_val) { struct TokenList * _ast_setup_patch_tokens_2; 
 ...
 * @brief Autogenerated docstring
 */
int test_patch_multiple_disjoint(TEST *_out_val) { struct TokenList * _ast_setup_patch_tokens_3; 
 ...
 * @brief Autogenerated docstring
 */
int test_patch_overlap_behavior(TEST *_out_val) { struct TokenList * _ast_setup_patch_tokens_4; 
 ...
 * @brief Autogenerated docstring
 */
int test_patch_append_end(TEST *_out_val) { struct TokenList * _ast_setup_patch_tokens_5; 
