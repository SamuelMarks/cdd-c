 ...
 */
int test_winhttp_lifecycle(TEST *_out_val) {
#ifdef _WIN32
 ...
 * @brief Autogenerated docstring
 */
int test_winhttp_config_usage(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_winhttp_send_fail(TEST *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int test_winhttp_send_null_checks(TEST *_out_val) {
#ifdef _WIN32
  struct HttpTransportContext *ctx = NULL;
  struct HttpRequest req;
  struct HttpResponse *res = NULL;
 ...
 * @brief Autogenerated docstring
 */
int test_winhttp_stubs(TEST *_out_val) {
#ifndef _WIN32
  struct HttpTransportContext *ctx = NULL;
  struct HttpConfig cfg;
  struct HttpRequest req;
