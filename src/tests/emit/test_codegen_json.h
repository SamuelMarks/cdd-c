 ...
 */
void setup_json_fields(struct StructFields *sf) {
 ...
 * @brief Autogenerated docstring
 */
int test_json_to_plain(TEST *_out_val) {
  FILE *tmp = tmpfile();
 ...
 * @brief Autogenerated docstring
 */
int test_json_from_plain(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
  long sz;
  char *content;
 ...
 * @brief Autogenerated docstring
 */
int test_json_recursive_obj(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_json_array_logic(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
  char *content;
  long sz;
 ...
 * @brief Autogenerated docstring
 */
int test_json_guards(TEST *_out_val) {
  FILE *tmp = tmpfile();
  struct StructFields sf;
 ...
 * @brief Autogenerated docstring
 */
int test_json_null_args(TEST *_out_val) {
