 ...
 */
int map_type_to_c_arg(const char *oa_type, const char **_out_val) {
  if (!oa_type) {
    *_out_val = "const void *";
    return 0;
  }
 ...
 * @brief Autogenerated docstring
 */
int is_primitive_type(const char *oa_type) {
  if (!oa_type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int param_is_object_kv(const struct OpenAPI_Parameter *p) {
  if (!p)
    return 0;
  if (p->is_array)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int media_type_base_len(const char *media_type, size_t *_out_val) {
  size_t i = 0;
  if (!media_type) {
    *_out_val = 0;
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int media_type_has_prefix(const char *media_type, const char *prefix) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_has_suffix(const char *media_type, const char *suffix) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_ieq(const char *media_type, const char *expected) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_json(const char *media_type) {
  if (!media_type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_form(const char *media_type) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_text_plain(const char *media_type) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_multipart(const char *media_type) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_multipart_form(const char *media_type) {
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_textual(const char *media_type) {
  if (!media_type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int media_type_is_binary(const char *media_type) {
  if (!media_type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int map_array_item_type(const char *oa_type, const char **_out_val) {
  if (!oa_type) {
    *_out_val = "const void *";
    return 0;
  }
 ...
 * @brief Autogenerated docstring
 */
void sanitize_ident(char *out, size_t outsz, const char *in) {
  size_t i = 0;
  size_t j = 0;
  if (!out || outsz == 0)
    return;
 ...
 * @brief Autogenerated docstring
 */
void multipart_header_param_name(char *out, size_t outsz,
 ...
 * @brief Autogenerated docstring
 */
int map_type_to_c_out(const char *oa_type, const char **_out_val) {
  if (!oa_type) {
    *_out_val = "void *";
    return 0;
  }
 ...
 * @brief Autogenerated docstring
 */
int map_array_item_type_out(const char *oa_type, const char **_out_val) {
  if (!oa_type) {
    *_out_val = "void **";
    return 0;
  }
 ...
 * @brief Autogenerated docstring
 */
int schema_has_inline(const struct OpenAPI_SchemaRef *schema) {
  if (!schema)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int get_success_response(const struct OpenAPI_Operation *op,
 ...
 * @brief Autogenerated docstring
 */
int response_is_binary_success(const struct OpenAPI_Operation *op) {
 ...
 * @brief Autogenerated docstring
 */
int get_success_schema(const struct OpenAPI_Operation *op,
