 ...
 */
int verb_to_enum_str(enum OpenAPI_Verb v, const char **_out_val) {
  switch (v) {
  case OA_VERB_GET: {
    *_out_val = "HTTP_GET";
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int method_str_to_enum_str(const char *method, const char **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int mapped_err_code(int status) {
  if (status == 400)
    return 22; /* EINVAL */
 ...
 * @brief Autogenerated docstring
 */
int find_encoding(const struct OpenAPI_MediaType *mt, const char *name,
 ...
 * @brief Autogenerated docstring
 */
int is_primitive_type(const char *type) {
  if (!type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int is_object_ref_type(const char *type) {
  if (!type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int struct_fields_all_primitive(const struct StructFields *sf) {
  size_t i;
  if (!sf)
    return 0;
  for (i = 0; i < sf->size; ++i) {
 ...
 * @brief Autogenerated docstring
 */
int first_content_type_entry(const char *content_type, char *buf,
 ...
 * @brief Autogenerated docstring
 */
int schema_inline_is_string(const struct OpenAPI_SchemaRef *schema) {
 ...
 * @brief Autogenerated docstring
 */
int response_is_textual_string(const struct OpenAPI_Response *resp) {
 ...
 * @brief Autogenerated docstring
 */
int schema_has_payload(const struct OpenAPI_SchemaRef *schema);

static /**
 * @brief Autogenerated docstring
 */
int response_is_binary(const struct OpenAPI_Response *resp) {
  if (!resp || !resp->content_type)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int write_text_plain_success(FILE *fp) {
  if (!fp)
    return EINVAL;
 ...
 * @brief Autogenerated docstring
 */
int write_binary_success(FILE *fp) {
  if (!fp)
    return EINVAL;
 ...
 * @brief Autogenerated docstring
 */
int write_inline_json_parse(FILE *fp,
 ...
 * @brief Autogenerated docstring
 */
int write_joined_form_array(FILE *fp, const char *field,
 ...
 * @brief Autogenerated docstring
 */
int write_header_param_logic(FILE *fp,
 ...
 * @brief Autogenerated docstring
 */
int write_form_urlencoded_body(FILE *fp,
                                      const struct OpenAPI_Operation *op,
 ...
 * @brief Autogenerated docstring
 */
int write_cookie_param_logic(FILE *fp,
                                    const struct OpenAPI_Operation *op) {
  size_t i;
  int has_cookie = 0;
 ...
 * @brief Autogenerated docstring
 */
int write_multipart_part_headers(FILE *fp,
                                        const struct OpenAPI_Encoding *enc) {
  size_t h;
 ...
 * @brief Autogenerated docstring
 */
int write_multipart_body(FILE *fp, const struct OpenAPI_Operation *op,
                                const struct OpenAPI_Spec *spec) {
 ...
 * @brief Autogenerated docstring
 */
int is_status_range_code(const char *code) {
  if (!code)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int status_range_prefix(const char *code) {
 ...
 * @brief Autogenerated docstring
 */
int is_status_code_literal(const char *code) {
