 ...
 */
void parsed_sig_init(struct ParsedSig *sig) {
  sig->attributes = NULL;
  sig->storage = NULL;
  sig->ret_type = NULL;
  sig->name = NULL;
 ...
 * @brief Autogenerated docstring
 */
void parsed_sig_free(struct ParsedSig *sig) {
  if (sig->attributes)
    free(sig->attributes);
  if (sig->storage)
    free(sig->storage);
 ...
 * @brief Autogenerated docstring
 */
int join_tokens(const struct TokenList *tokens, size_t start, size_t end,
                       char **out) {
  size_t len = 0;
  size_t i;
  char *buf;
 ...
 * @brief Autogenerated docstring
 */
int is_storage_specifier(const struct Token *tok) {
  switch (tok->kind) {
 ...
 * @brief Autogenerated docstring
 */
int find_balanced_end(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int check_is_void(const struct TokenList *tokens, size_t start,
                         size_t end) {
  size_t i;
  int saw_void = 0;
 ...
 * @brief Autogenerated docstring
 */
int args_represent_void(const char *args) {
  const char *p = args;
 ...
 * @brief Autogenerated docstring
 */
int has_meaningful_tokens(const struct TokenList *tokens, size_t start,
                                 size_t end) {
  size_t i;
  for (i = start; i < end; ++i) {
    if (tokens->tokens[i].kind != TOKEN_WHITESPACE &&
