 ...
 */
int find_refactored_func(const struct RefactoredFunction *funcs,
 ...
 * @brief Autogenerated docstring
 */
int extract_token_text(const struct Token *tok, char **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int find_semicolon(const struct TokenList *tokens, size_t start,
                          size_t *_out_val) {
  size_t i;
 ...
 * @brief Autogenerated docstring
 */
int find_stmt_start(const struct TokenList *tokens, size_t pos,
                           size_t *_out_val) {
  size_t i = pos;
  while (i > 0) {
