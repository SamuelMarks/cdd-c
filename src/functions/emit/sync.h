 ...
 */
extern C_CDD_EXPORT cdd_c_error_t sync_code_main(int argc, char **argv);
 ...
 */
extern C_CDD_EXPORT cdd_c_error_t patch_header_from_source(
    const char *header_path, const char *refactored_source);
