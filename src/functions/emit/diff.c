 ...
 */
void split_lines(const char *str, size_t len,
 ...
 * @brief Autogenerated docstring
 */
int generate_block_new_text(const struct Block *b,
 ...
 * @brief Autogenerated docstring
 */
void append_to_diff(char **diff_str, size_t *diff_len, size_t *diff_cap,
                           const char *format, ...) {
  va_list args;
  int printed;
  if (!*diff_str) {
