 ...
 * @brief Autogenerated docstring
 */
int add_violation(struct AuditStats *stats, const char *file_path,
 ...
 * @brief Autogenerated docstring
 */
void get_line_col(const char *content, const uint8_t *token_ptr,
 ...
 * @brief Autogenerated docstring
 */
int count_returning_allocs(const struct TokenList *tokens) {
  size_t i;
  int count = 0;
 ...
 * @brief Autogenerated docstring
 */
int audit_file_callback(const char *path, void *user_data) {
