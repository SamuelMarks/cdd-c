 ...
 */
int skip_ws(const struct TokenList *tokens, size_t i, size_t limit,
                   size_t *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int skip_ws_back(const struct TokenList *tokens, size_t i,
                        size_t *_out_val) {
  if (i == 0) {
 ...
 * @brief Autogenerated docstring
 */
int is_type_start(const struct Token *tok) {
 ...
 * @brief Autogenerated docstring
 */
int match_function_definition(const struct TokenList *tokens,
 ...
 * @brief Autogenerated docstring
 */
int consume_balanced_parens(const struct TokenList *tokens,
 ...
 * @brief Autogenerated docstring
 */
int consume_attributes(const struct TokenList *tokens,
 ...
 * @brief Autogenerated docstring
 */
int consume_static_assert(const struct TokenList *tokens,
                                 size_t start, size_t limit, size_t *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int consume_generic_selection(const struct TokenList *tokens,
                                     size_t start, size_t limit,
                                     size_t *_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int is_expression_brace(const struct TokenList *tokens,
                               size_t brace_idx) {
 ...
 * @brief Autogenerated docstring
 */
int consume_balanced_braces(const struct TokenList *tokens,
                                   size_t start, size_t limit,
                                   size_t *_out_val) {
  size_t i = start;
  int depth = 0;
 ...
 * @brief Autogenerated docstring
 */
int parse_recursive(const struct TokenList *tokens, size_t start,
