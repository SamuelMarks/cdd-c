 ...
 * @brief Autogenerated docstring
 */
int get_assigned_var(const struct TokenList *tokens, size_t assign_idx,
                            char **_out_val) {
  size_t i = assign_idx;
  if (assign_idx == 0) {
    *_out_val = NULL;
 ...
 * @brief Autogenerated docstring
 */
int is_inside_condition(const struct TokenList *tokens, size_t idx) {
  size_t i = idx;
  int paren_depth = 0;
 ...
 * @brief Autogenerated docstring
 */
int is_dereference_use(const struct TokenList *tokens, size_t i) {
  if (i > 0) {
    size_t prev = i - 1;
