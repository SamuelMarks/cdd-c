 ...
 */
int join_tokens_range(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int skip_ws_back(const struct TokenList *tokens, size_t i, size_t limit,
                        size_t *_out_val) {
  if (i <= limit) {
    *_out_val = SIZE_MAX;
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int skip_group(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
void free_decl_type(struct DeclType *t) {
  if (!t)
    return;
 ...
 * @brief Autogenerated docstring
 */
int add_type_node(struct DeclInfo *info, struct DeclType **current_tail,
 ...
 * @brief Autogenerated docstring
 */
int create_node(enum DeclTypeKind kind, struct DeclType **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int is_grouping_paren(const struct TokenList *tokens, size_t paren_idx,
                             size_t limit) {
 ...
 * @brief Autogenerated docstring
 */
int find_abstract_pivot(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int find_pivot(const struct TokenList *tokens, size_t start, size_t end,
