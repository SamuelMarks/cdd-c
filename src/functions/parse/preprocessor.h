 ...
 * @brief Autogenerated docstring
 */
int pp_add_search_path(struct PreprocessorContext *ctx,
                                           const char *path);
 ...
 * @brief Autogenerated docstring
 */
int pp_add_macro(struct PreprocessorContext *ctx,
 ...
 * @brief Autogenerated docstring
 */
int pp_scan_defines(struct PreprocessorContext *ctx,
                                        const char *filename);
