 ...
 */
int cmake_modifier_init(struct CMakeModifier *mod,
                                            const char *filepath,
 ...
 * @brief Autogenerated docstring
 */
int cmake_modifier_add_compile_opt(struct CMakeModifier *mod,
                                                       const char *opt);
 ...
 * @brief Autogenerated docstring
 */
int cmake_modifier_add_link_lib(struct CMakeModifier *mod,
                                                    const char *lib);
