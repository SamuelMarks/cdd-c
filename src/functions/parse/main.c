 ...
 */
void print_error(int rc, const char *command_name) {
  if (rc == 0)
    return;
 ...
 * @brief Autogenerated docstring
 */
void print_version(void) { printf("cdd-c version %s\n", C_CDD_VERSION); }

static /**
 * @brief Autogenerated docstring
 */
int handle_from_openapi(int argc, char **argv) {
 ...
 * @brief Autogenerated docstring
 */
int handle_to_openapi(int argc, char **argv) {
