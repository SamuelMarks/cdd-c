...
static enum cdd_c_error cdd_sha256_transform(struct cdd_sha256_ctx *ctx,
                                             const uint8_t data[]) {
...
static enum cdd_c_error cdd_sha256_update(struct cdd_sha256_ctx *ctx,
...
static enum cdd_c_error cdd_sha256_final(struct cdd_sha256_ctx *ctx,
                                         uint8_t hash[]) {
  uint32_t i;
  i = ctx->datalen;
  if (ctx->datalen < 56) {
