 ...
 */
int get_token_slice(const struct TokenList *src, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int find_token_in_range(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int token_eq_str(const struct Token *tok, const char *s) {
  size_t len = strlen(s);
 ...
 * @brief Autogenerated docstring
 */
int extract_func_name(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
int join_tokens_str(const struct TokenList *tokens, size_t start,
 ...
 * @brief Autogenerated docstring
 */
void analyze_signature_tokens(const struct TokenList *tokens,
 ...
 * @brief Autogenerated docstring
 */
int graph_add_node(struct DependencyGraph *g, size_t idx,
                          const char *name) {
 ...
 * @brief Autogenerated docstring
 */
int graph_add_edge(struct DependencyGraph *g, size_t caller_idx,
                          size_t callee_idx) {
 ...
 * @brief Autogenerated docstring
 */
void graph_free_contents(struct DependencyGraph *g) {
  size_t i;
  if (!g || !g->nodes)
    return;
  for (i = 0; i < g->count; i++) {
 ...
 * @brief Autogenerated docstring
 */
void propagate_refactor_mark(struct DependencyGraph *g, size_t idx) {
 ...
 * @brief Autogenerated docstring
 */
int is_c_source(const char *path) {
 ...
 * @brief Autogenerated docstring
 */
int fix_file_callback(const char *path, void *user_data) {
