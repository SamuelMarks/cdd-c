#ifndef CDD_FFI_EMIT_JULIA_H
#define CDD_FFI_EMIT_JULIA_H
...
/**
 * @brief Emits Julia (ccall) bindings for the given FFI IR.
 * @param ir The extracted and topologically sorted FFI IR.
 * @param config The generation config.
 * @return 0 on success, or an error code.
 */
C_CDD_EXPORT cdd_c_error_t cdd_ffi_emit_julia(
