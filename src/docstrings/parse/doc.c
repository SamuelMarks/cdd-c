 ...
 * @brief Autogenerated docstring
 */
int skip_ws(const char *p, const char **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int extract_word(const char *str, const char *end, const char **next_out,
                        char **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int extract_rest(const char *str, const char *end, char **_out_val) {
 ...
 * @brief Autogenerated docstring
 */
int add_tag(struct DocMetadata *out, const char *tag) {
 ...
 * @brief Autogenerated docstring
 */
int add_tag_meta(struct DocMetadata *out, struct DocTagMeta *meta) {
 ...
 * @brief Autogenerated docstring
 */
int trim_segment(char *s, char **_out_val) {
  char *start;
  char *end;
  if (!s) {
    *_out_val = NULL;
 ...
 * @brief Autogenerated docstring
 */
int parse_tags_line(const char *line, const char *end,
 ...
 * @brief Autogenerated docstring
 */
int parse_bool_text(const char *s, int *out) {
  if (!s || !out)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
int parse_tag_meta_line(const char *line, const char *end,
                               struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_style_text(const char *s, enum DocParamStyle *out) {
  if (!s || !out)
    return 0;
 ...
 * @brief Autogenerated docstring
 */
void parse_optional_bool_attr(const char *attr, const char *key,
 ...
 * @brief Autogenerated docstring
 */
int parse_optional_example_attr(const char *attr, char **out_example) {
 ...
 * @brief Autogenerated docstring
 */
int parse_deprecated_line(const char *line, const char *end,
                                 struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_external_docs_line(const char *line, const char *end,
                                    struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_contact_line(const char *line, const char *end,
                              struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_license_line(const char *line, const char *end,
                              struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_response_header_line(const char *line, const char *end,
                                      struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_link_line(const char *line, const char *end,
                           struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_param_line(const char *line, const char *end,
                            struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_return_line(const char *line, const char *end,
                             struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int split_scopes(const char *input, char ***out_scopes,
                        size_t *out_count) {
 ...
 * @brief Autogenerated docstring
 */
int parse_security_line(const char *line, const char *end,
                               struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_security_type_text(const char *text,
 ...
 * @brief Autogenerated docstring
 */
int parse_security_in_text(const char *text,
 ...
 * @brief Autogenerated docstring
 */
int parse_oauth_flow_type_text(const char *text,
 ...
 * @brief Autogenerated docstring
 */
int parse_oauth_scopes(const char *input, struct DocOAuthScope **out,
                              size_t *out_count) {
  char **names = NULL;
  size_t n = 0;
  size_t i;
 ...
 * @brief Autogenerated docstring
 */
int parse_security_scheme_line(const char *line, const char *end,
                                      struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int find_key_token(char *s, const char *key, size_t *key_len,
                          char **_out_val) {
  char *p;
  size_t klen;
  if (!s || !key) {
 ...
 * @brief Autogenerated docstring
 */
int parse_server_line(const char *line, const char *end,
                             struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int split_enum_values(const char *input, char ***out_vals,
                             size_t *out_count) {
 ...
 * @brief Autogenerated docstring
 */
int parse_server_var_line(const char *line, const char *end,
                                 struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_encoding_line(const char *line, const char *end,
 ...
 * @brief Autogenerated docstring
 */
int parse_request_body_line(const char *line, const char *end,
                                   struct DocMetadata *out) {
 ...
 * @brief Autogenerated docstring
 */
int parse_route_line(const char *line, const char *end,
                            struct DocMetadata *out) {
