...
_Note: As with all massive automated refactoring tools, this should be executed on a clean git working tree so that changes can be easily reviewed or discarded if any manual touch-ups are needed (e.g. system callbacks)._
