...
TEST test_load_schema_external_docs_discriminator_xml(void) {
  const char *json = "{\"paths\":{\"/p\":{\"get\":{\"parameters\":[{"
                     "\"name\":\"id\",\"in\":\"query\","
                     "\"schema\":{"
                     "\"type\":\"string\","
...
TEST test_request_body_content_required(void) {
  const char *json = "{\"paths\":{\"/login\":{\"post\":{"
                     "\"requestBody\":{},"
...
TEST test_param_content_multiple_entries_rejected(void) {
  const char *json = "{\"paths\":{\"/q\":{\"get\":{\"parameters\":[{"
                     "\"name\":\"q\",\"in\":\"query\","
...
TEST test_header_content_multiple_entries_rejected(void) {
  const char *json = "{\"paths\":{\"/r\":{\"get\":{\"responses\":{\"200\":{"
                     "\"description\":\"OK\","
...
TEST test_paths_require_leading_slash(void) {
  const char *json = "{\"paths\":{\"pets\":{\"get\":{\"responses\":{\"200\":{"
                     "\"description\":\"OK\"}}}}}}";
  struct OpenAPI_Spec spec;
  int rc = load_spec_str(json, &spec);
  ASSERT_EQ(EINVAL, rc);
...
TEST test_tag_duplicate_rejected(void) {
  const char *json = "{\"tags\":[{\"name\":\"dup\"},{\"name\":\"dup\"}]}";
  struct OpenAPI_Spec spec;
  int rc = load_spec_str(json, &spec);
  ASSERT_EQ(EINVAL, rc);
  openapi_spec_free(&spec);
...
TEST test_tag_name_required(void) {
  const char *json = "{\"tags\":[{\"description\":\"missing\"}]}";
  struct OpenAPI_Spec spec;
  int rc = load_spec_str(json, &spec);
  ASSERT_EQ(EINVAL, rc);
  openapi_spec_free(&spec);
...
TEST test_tag_parent_missing_rejected(void) {
  const char *json = "{\"tags\":[{\"name\":\"child\",\"parent\":\"ghost\"}]}";
  struct OpenAPI_Spec spec;
  int rc = load_spec_str(json, &spec);
  ASSERT_EQ(EINVAL, rc);
  openapi_spec_free(&spec);
...
TEST test_tag_parent_cycle_rejected(void) {
  const char *json = "{\"tags\":[{\"name\":\"a\",\"parent\":\"b\"},"
                     "{\"name\":\"b\",\"parent\":\"a\"}]}";
  struct OpenAPI_Spec spec;
  int rc = load_spec_str(json, &spec);
  ASSERT_EQ(EINVAL, rc);
...
TEST test_external_docs_url_required(void) {
  const char *json = "{\"externalDocs\":{\"description\":\"Docs\"}}";
  struct OpenAPI_Spec spec;
  int rc = load_spec_str(json, &spec);
  ASSERT_EQ(EINVAL, rc);
  openapi_spec_free(&spec);
...
TEST test_operation_id_duplicate_in_callback_rejected(void) {
  const char *json = "{\"paths\":{\"/pets\":{\"get\":{"
                     "\"operationId\":\"dup\","
                     "\"responses\":{\"200\":{\"description\":\"OK\"}},"
...
TEST test_load_querystring_parameter(void) {
  const char *json = "{\"paths\":{\"/search\":{\"get\":{\"parameters\":[{"
...
TEST test_ignore_reserved_header_parameters(void) {
  const char *json = "{\"paths\":{\"/h\":{\"get\":{\"parameters\":["
...
TEST test_load_header_content_media_type(void) {
  const char *json = "{\"paths\":{\"/p\":{\"get\":{\"responses\":{"
...
TEST test_load_security_scheme_deprecated(void) {
  const char *json = "{\"components\":{\"securitySchemes\":{"
...
TEST test_load_component_examples(void) {
  const char *json = "{\"components\":{\"examples\":{"
...
TEST test_load_operation_metadata(void) {
  const char *json = "{\"paths\":{\"/meta\":{\"get\":{"
                     "\"operationId\":\"getMeta\","
...
TEST test_load_query_verb_and_external_docs(void) {
  const char *json = "{\"paths\":{\"/search\":{\"query\":{"
...
TEST test_load_additional_operations(void) {
  const char *json = "{\"paths\":{\"/copy\":{\"additionalOperations\":{"
...
TEST test_load_path_template_missing_param(void) {
  const char *json = "{\"paths\":{\"/pets/{petId}\":{\"get\":{"
                     "\"responses\":{\"200\":{\"description\":\"OK\"}}"
                     "}}}}";
