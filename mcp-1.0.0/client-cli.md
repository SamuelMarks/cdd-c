...
| :--- | :---: | :---: | :---: | :--- |
| **Generator CLI (`stdio`)** | | | | |
| Code Scaffold / Generate Tools | `[x]` , `[ ]` | `[x]` , `[ ]` | `[x]` , `[x]` | AI can invoke standard generator CLI commands via MCP |
...
| In-Memory Generation Router | `[x]` , `[ ]` | `[x]` , `[ ]` | `[x]` , `[x]` | Native bindings to run the generator core directly via MCP |
...
| :--- | :---: | :---: | :---: | :--- |
| **Transports** | | | | |
| Standard I/O \(stdio\) | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[ ]` | stdin/stdout message passing |
| Server-Sent Events \(sse\) | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[ ]` | HTTP POST + SSE streams |
| Custom Transports | `[ ]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | Pluggable transport interface |
| **JSON-RPC 2.0 Mechanics** | | | | |
| Message Parsing & Serialization | `[x]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[ ]` | |
| Request ID Mapping/Resolution | `[x]` , `[x]` | `[x]` , `[ ]` | `[x]` , `[ ]` | Resolving async responses to requests |
...
| Human-in-the-loop \(Sampling\) | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[ ]` | Prompting user before LLM generation |
| Human-in-the-loop \(Tools\) | `[ ]` , `[ ]` | `[x]` , `[x]` | `[x]` , `[ ]` | Security approvals/denials for tool calls |
...
| **CallToolRequest** | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolRequest (`method`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolRequest (`params`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolRequest (`params`) (`arguments`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolRequest (`params`) (`name`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| **CallToolResult** | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolResult (`_meta`) | `[ ]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolResult (`content`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CallToolResult (`isError`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| **CancelledNotification** | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| CancelledNotification (`method`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
...
| **ListToolsRequest** | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| ListToolsRequest (`method`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| ListToolsRequest (`params`) | `[ ]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| ListToolsRequest (`params`) (`cursor`) | `[ ]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| **ListToolsResult** | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| ListToolsResult (`_meta`) | `[ ]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| ListToolsResult (`nextCursor`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| ListToolsResult (`tools`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| **LoggingLevel** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | |
...
| **ProgressToken** | `[x]` , `[x]` | `[ ]` , `[ ]` | `[ ]` , `[ ]` | |
| **Prompt** | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| Prompt (`arguments`) | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| Prompt (`description`) | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| Prompt (`name`) | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| **PromptArgument** | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| PromptArgument (`description`) | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| PromptArgument (`name`) | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
| PromptArgument (`required`) | `[x]` , `[ ]` | `[x]` , `[x]` | `[ ]` , `[ ]` | |
...
| **Tool** | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| Tool (`description`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| Tool (`inputSchema`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| Tool (`inputSchema`) (`properties`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| Tool (`inputSchema`) (`required`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| Tool (`inputSchema`) (`type`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
| Tool (`name`) | `[x]` , `[x]` | `[x]` , `[ ]` | `[ ]` , `[ ]` | |
